...
const RELATED = [
  ...
  { icon: 'fa-brands fa-meta', title: 'Meta Ads', desc: 'Facebook and Instagram campaigns built on precise audience targeting and creative testing.', href: '/meta-ads-management' },
            ...
            <div className="yads-hero-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1.05fr) minmax(0,0.95fr)', gap: 56, alignItems: 'center', position: 'relative', zIndex: 1 }}>
              ...
              <div>
                ...
                <p style={{ fontFamily: I, fontSize: 'clamp(15px,1.2vw,17px)', color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 520, marginBottom: 36 }}>
                  ...
                  earn attention, build trust, and convert viewers into leads and customers.
                </p>
