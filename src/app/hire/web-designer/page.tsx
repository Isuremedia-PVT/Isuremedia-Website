...
const whatYouGet = [
  { icon: 'fa-solid fa-palette', title: 'Beautiful Designs That Convert', desc: 'Our designers blend aesthetics with conversion principles — every layout, colour choice, and CTA placement is intentional and data-informed.' },
  { icon: 'fa-solid fa-bolt', title: 'Onboarded in 48 Hours', desc: 'No lengthy hiring rounds. We match you with a vetted web designer suited to your brand and get them working fast.' },
  { icon: 'fa-solid fa-layer-group', title: 'Design + Strategy Alignment', desc: 'Our designers work with your marketing goals, not just your brief. They understand funnels, conversion points, and brand positioning.' },
];

const engagements = [
  { title: 'Part-Time', hours: '20 hrs/week', desc: 'Perfect for ongoing design support, landing pages, social assets, or iterative improvements to an existing site.', price: 'From $700/mo' },
  { title: 'Full-Time', hours: '40 hrs/week', desc: 'A dedicated designer embedded in your team — ideal for full rebrands, product design, or agency white-label work.', price: 'From $1,200/mo' },
  { title: 'Project-Based', hours: 'Fixed scope', desc: 'One-off website design, app UI, or brand identity project? We scope and deliver it to spec.', price: 'Custom quote' },
];

const whyISM = [
  { icon: 'fa-solid fa-user-check', title: 'Portfolio-Vetted Designers', desc: 'Every designer we place has been assessed on design quality, brand understanding, and client communication skills.' },
  { icon: 'fa-solid fa-rotate', title: 'Replacement Guarantee', desc: 'Not happy with the fit? We replace your designer within 5 business days at no extra cost.' },
  { icon: 'fa-solid fa-clock', title: 'Deadline-Driven Culture', desc: 'We only work with designers who understand business timelines and deliver on schedule.' },
  { icon: 'fa-solid fa-comments', title: 'Clear Communication', desc: 'File handoffs via Figma, weekly reviews, and Slack availability keep you in the loop at all times.' },
];

const steps = [
  { num: '01', title: 'Post Your Brief', desc: 'Share your brand, audience, goals, and design preferences.' },
  { num: '02', title: 'Interview Candidates', desc: 'We shortlist 2-3 designers with relevant portfolio experience.' },
  { num: '03', title: 'Start Working', desc: 'Your designer gets onboarded and begins delivering immediately.' },
  { num: '04', title: 'Deliver Results', desc: 'Review designs, provide feedback, and launch with confidence.' },
];
      ...
      <section style={{ background: 'var(--color-bg-soft)', padding: '88px 0 80px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 16px', marginBottom: 24 }}>
            <i className="fa-solid fa-pen-nib" style={{ fontSize: 12, color: 'var(--color-primary)' }} />
          ...
          <h1 style={{ maxWidth: 760, marginBottom: 24 }}>Hire a Web Designer — Beautiful, High-Converting Design</h1>
          <p style={{ fontFamily: I, fontSize: 18, color: 'var(--color-text-muted)', lineHeight: 1.75, maxWidth: 620, marginBottom: 40 }}>
            Get a dedicated web designer who combines visual excellence with conversion strategy. Vetted by Isuremedia, ready to start in 48 hours, and built to make your brand look its best.
          </p>
      ...
      <section style={{ background: '#fff', padding: '80px 0' }}>
        <div className="ism-container">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', maxWidth: 560, margin: '0 auto' }}>Design talent that understands your business goals.</p>
          </div>
          ...
          <div className="skills-inner" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
            <div>
              ...
              <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', lineHeight: 1.75, marginBottom: 32 }}>
                Our designers are fluent in modern design tools and frameworks. They create experiences that look stunning on every screen and guide users towards conversion.
              </p>
              <a href="/contact" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 28px', borderRadius: 8, fontFamily: J, fontSize: 14, fontWeight: 700, color: 'var(--color-navy)', background: 'var(--ism-amber)', textDecoration: 'none', letterSpacing: '.04em', textTransform: 'uppercase', boxShadow: '0 6px 20px rgba(255,176,0,.35)', transition: 'all .18s' }}
                onMouseEnter={e => { e.currentTarget.style.background = 'var(--color-accent-hover)'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
                onMouseLeave={e => { e.currentTarget.style.background = 'var(--ism-amber)'; e.currentTarget.style.transform = ''; }}>
                Discuss Your Project <i className="fa-solid fa-arrow-right" style={{ fontSize: 11 }} />
              </a>
            </div>
      ...
      <section style={{ background: '#fff', padding: '80px 0' }}>
        <div className="ism-container">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', maxWidth: 500, margin: '0 auto' }}>Flexible options that scale with your design needs.</p>
          </div>
      ...
      <section style={{ background: 'var(--color-bg-soft)', padding: '80px 0' }}>
        <div className="ism-container">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', maxWidth: 520, margin: '0 auto' }}>We match you with designers who deliver, not just impress.</p>
          </div>
      ...
      <section id="how-it-works" style={{ background: '#fff', padding: '80px 0' }}>
        <div className="ism-container">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', maxWidth: 480, margin: '0 auto' }}>From brief to first designs in as little as 48 hours.</p>
          </div>
