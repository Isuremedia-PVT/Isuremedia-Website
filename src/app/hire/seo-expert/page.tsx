...
const whatYouGet = [
  { icon: 'fa-solid fa-magnifying-glass-chart', title: 'Proven Ranking Strategies', desc: 'Our SEO experts use white-hat, algorithm-proof strategies that build sustainable organic traffic — not shortcuts that burn out in 3 months.' },
  { icon: 'fa-solid fa-bolt', title: 'Fast Start, Measurable Results', desc: 'Get an expert reviewing your site within 48 hours. We run technical audits, keyword mapping, and content gap analysis fast.' },
  { icon: 'fa-solid fa-chart-line', title: 'Real Organic Growth', desc: 'From 0 to ranking pages, from 1,000 to 50,000 monthly visitors — our SEO experts have driven growth across every industry.' },
];

const engagements = [
  { title: 'Part-Time', hours: '20 hrs/week', desc: 'Best for ongoing technical SEO maintenance, content optimisation, or local SEO campaigns.', price: 'From $900/mo' },
  { title: 'Full-Time', hours: '40 hrs/week', desc: 'A dedicated SEO expert embedded in your team — ideal for aggressive growth campaigns, enterprise SEO, or agency overflow.', price: 'From $1,600/mo' },
  { title: 'Project-Based', hours: 'Fixed scope', desc: 'Need a comprehensive SEO audit, site migration, or content strategy? We scope it and deliver.', price: 'Custom quote' },
];

const whyISM = [
  { icon: 'fa-solid fa-user-check', title: 'Results-Vetted Experts', desc: 'We only place SEO experts who can demonstrate real results — not just theory. Case studies and traffic growth are required.' },
  ...
  { icon: 'fa-solid fa-file-lines', title: 'Monthly Reporting', desc: 'Detailed ranking reports, traffic analysis, and ROI summaries so you always know exactly what your investment is doing.' },
  { icon: 'fa-solid fa-comments', title: 'Strategy-First Approach', desc: 'We don\'t just execute tasks. Our SEO experts build a tailored strategy around your goals and update it as your market evolves.' },
];

const steps = [
  { num: '01', title: 'Post Your Brief', desc: 'Share your website, industry, goals, and current SEO situation.' },
  { num: '02', title: 'Interview Candidates', desc: 'We shortlist 2-3 vetted SEO experts with relevant industry experience.' },
  { num: '03', title: 'Start Working', desc: 'Your expert runs an initial audit and delivers a 90-day strategy.' },
  { num: '04', title: 'Deliver Results', desc: 'Track rankings, traffic, and conversions as results build.' },
];
      ...
      <section style={{ background: 'var(--color-bg-soft)', padding: '88px 0 80px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', position: 'relative', zIndex: 1 }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 16px', marginBottom: 24 }}>
            <i className="fa-solid fa-magnifying-glass" style={{ fontSize: 12, color: 'var(--color-primary)' }} />
          ...
          <h1 style={{ maxWidth: 760, marginBottom: 24 }}>Hire an SEO Expert — Proven Rankings, Real Organic Growth</h1>
          <p style={{ fontFamily: I, fontSize: 18, color: 'var(--color-text-muted)', lineHeight: 1.75, maxWidth: 620, marginBottom: 40 }}>
            Stop guessing at SEO. Get a dedicated, vetted SEO expert from Isuremedia who brings proven strategies, technical depth, and measurable results. Onboarded in 48 hours.
          </p>
      ...
      <section style={{ background: '#fff', padding: '80px 0' }}>
        <div className="ism-container">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', maxWidth: 560, margin: '0 auto' }}>SEO expertise built for real, lasting organic growth.</p>
          </div>
          ...
          <div className="skills-inner" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
            <div>
              ...
              <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', lineHeight: 1.75, marginBottom: 32 }}>
                Our SEO experts combine technical mastery with content strategy and off-page authority building. They know how Google thinks — and how to make it work in your favour.
              </p>
              <a href="/contact" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 28px', borderRadius: 8, fontFamily: J, fontSize: 14, fontWeight: 700, color: 'var(--color-navy)', background: 'var(--ism-amber)', textDecoration: 'none', letterSpacing: '.04em', textTransform: 'uppercase', boxShadow: '0 6px 20px rgba(255,176,0,.35)', transition: 'all .18s' }}
                onMouseEnter={e => { e.currentTarget.style.background = 'var(--color-accent-hover)'; e.currentTarget.style.transform = 'translateY(-2px)'; }}
                onMouseLeave={e => { e.currentTarget.style.background = 'var(--ism-amber)'; e.currentTarget.style.transform = ''; }}>
                Discuss Your SEO Goals <i className="fa-solid fa-arrow-right" style={{ fontSize: 11 }} />
              </a>
            </div>
      ...
      <section style={{ background: '#fff', padding: '80px 0' }}>
        <div className="ism-container">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', maxWidth: 500, margin: '0 auto' }}>SEO engagement built around your growth goals.</p>
          </div>
      ...
      <section style={{ background: 'var(--color-bg-soft)', padding: '80px 0' }}>
        <div className="ism-container">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', maxWidth: 520, margin: '0 auto' }}>We are your end-to-end SEO talent partner.</p>
          </div>
      ...
      <section id="how-it-works" style={{ background: '#fff', padding: '80px 0' }}>
        <div className="ism-container">
          <div style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', maxWidth: 480, margin: '0 auto' }}>From brief to first audit report in as little as 48 hours.</p>
          </div>
