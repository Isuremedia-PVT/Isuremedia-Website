...
const whyWPCards = [
  { icon: 'fa-solid fa-arrow-down', title: 'Leads Never Fall Through the Cracks', desc: <>Every lead that comes in, from any source, goes into the right pipeline stage automatically. Follow-up starts within minutes without anyone manually doing it. Missed calls get a text back. No lead sits untouched because someone forgot to check the CRM.</> },
...
const servicesData = [
  {
    ...
    desc: <>A GHL account that is not properly structured from the start causes problems for every automation built on top of it. Get a CRM built around your actual sales process, with the right pipelines, stages, custom fields, tags, and contact organization to support the way your business actually works.</>,
    bullets: [
      ...
      'User roles, permissions, and team setup',
      'Lead source tracking and attribution',
      'CRM cleanup and restructure for existing accounts',
    ],
  },
  {
    ...
    bullets: [
      ...
      'Pipeline stage movement triggers and actions',
      'If/Else conditional logic and branching sequences',
      'Missed call text-back and re-engagement flows',
      'Cross-channel automation across email, SMS, and voice',
    ],
  },
  {
    ...
    bullets: [
      ...
      'Full websites built inside GHL',
      'Thank-you pages and post-opt-in sequences',
      'Booking pages connected directly to calendar and pipeline',
  ...
  },
  {
    ...
    bullets: [
      ...
      'AI-powered appointment booking configuration',
      'Fallback and escalation to human agent setup',
      'AI chatbot for website, SMS, and social channels',
      'Voice AI agent for missed calls and inbound inquiries',
    ],
  },
  {
  ...
  },
  {
    ...
    bullets: [
      ...
      'Snapshot creation and sub-account deployment',
      'Branded mobile app configuration',
      'Client onboarding workflow and welcome sequences',
  ...
  },
  {
    ...
    bullets: [
      ...
      'ClickFunnels to GoHighLevel funnel migration',
      'Kajabi course and membership migration',
      'Mailchimp list and campaign migration',
      'Contact, tag, and automation logic preservation',
    ],
  },
  {
    ...
    bullets: [
      ...
      'Campaign attribution and lead source reporting',
      'Team activity and task completion reporting',
      'Revenue tracking and deal value reporting',
...
const techCategories = [
  { label: 'GoHighLevel Native Features', tools: ['CRM and Pipelines', 'Workflow Builder', 'Funnel Builder', 'Website Builder', 'Email and SMS', 'Conversation AI', 'Voice AI Agent', 'Calendars', 'Reputation Management', 'SaaS Mode', 'Membership Sites', 'Reporting Dashboards'] },
  { label: 'Integrations and Connections', tools: ['Zapier', 'Make (Integromat)', 'n8n', 'Stripe', 'Twilio', 'Mailgun', 'SendGrid', 'Google Workspace', 'Facebook Lead Ads', 'Google Ads', 'Calendly'] },
  { label: 'Platforms Migrated From', tools: ['HubSpot', 'ActiveCampaign', 'ClickFunnels', 'Kajabi', 'Mailchimp', 'Keap (Infusionsoft)', 'Pipedrive', 'Zoho CRM'] },
  { label: 'Communication and Channels', tools: ['Email', 'SMS', 'WhatsApp', 'Voice', 'Live Chat', 'Instagram DM', 'Facebook Messenger', 'Google Business Chat'] },
  { label: 'AI and Automation Tools', tools: ['GoHighLevel Conversation AI', 'GoHighLevel Voice Agent', 'OpenAI API integration', 'Retell AI', 'Custom webhook automations'] },
  { label: 'Development and Build Tools', tools: ['GoHighLevel Snapshot system', 'Custom CSS for GHL pages', 'API webhooks', 'GoHighLevel White-Label mobile app', 'Sub-account templates'] },
];

const whyISMCards = [
  { icon: 'fa-solid fa-certificate', title: 'GoHighLevel Certified', desc: <>ISureMedia is GoHighLevel Certified. This is not a casual claim. Certification covers the platform at a production level, not just the basics. It means the team builds with a depth of knowledge that most freelancers calling themselves GHL experts do not have.</> },
...
const engagementModels = [
  {
    ...
    desc: <>You need a full system build, a migration from another platform, a SaaS Mode setup, or an account that needs fixing properly. The scope is mapped before work starts, you know the cost upfront, and a dedicated GHL expert sees it through from architecture to handover.</>,
    bullets: [
      ...
      <section className="wp-hero" style={{ background: '#ffffff', padding: '92px 0 84px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: 960, margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 1, textAlign: 'center' }}>
          ...
          <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', lineHeight: 1.75, maxWidth: 720, margin: '0 auto 32px' }}>
            Get GoHighLevel built, fixed, or scaled by a certified expert who knows the platform properly, covering everything from CRM setup and workflow automation to funnel builds, AI chatbots, white-label SaaS configuration, and full system migrations from HubSpot, ActiveCampaign, and ClickFunnels.
          </p>
            ...
            <div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px 24px', marginBottom: 40 }}>
                {[
                  ...
                  'Funnels & Websites', 'AI Chatbots',
                  'Email & SMS', 'White-Label SaaS'
                ].map(item => (
        ...
        <div className="ism-container">
          <div style={{ textAlign: 'center', marginBottom: 72 }}>
            <h2 style={{ fontFamily: J, fontSize: 'clamp(32px,4vw,48px)', fontWeight: 900, color: 'var(--color-navy)', letterSpacing: '-0.5px', lineHeight: 1.2, margin: 0 }}>
              Technologies and Tools<br />Our <span style={{ color: 'var(--ism-amber)' }}>GoHighLevel Specialists</span> Work With
            </h2>
          </div>
          ...
          <div className="wp-cta-card" style={{ position: 'relative', background: 'var(--ism-blue-50)', borderRadius: 24, padding: '24px 60px', display: 'grid', gridTemplateColumns: '1fr clamp(220px, 30vw, 320px)', alignItems: 'end', gap: 60, minHeight: 180 }}>
            ...
            <div style={{ position: 'relative', zIndex: 2, padding: '10px 0', alignSelf: 'center' }}>
              ...
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 560, marginBottom: 24 }}>
                Tell us what your WordPress site needs and get a free proposal back with no obligation.
              </p>
