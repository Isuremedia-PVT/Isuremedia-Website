...
const WHO_FOR = [
  { icon: 'fa-solid fa-arrow-trend-down', title: 'Businesses whose organic traffic is declining', desc: 'If your rankings have held but traffic has dropped, AI Overviews are almost certainly taking clicks from your organic results. AI SEO addresses the root cause directly.', img: '/services-six-card/Seo/ai seo/Businesses whose organictraffic is declining.webp' },
  { icon: 'fa-solid fa-chess', title: 'Businesses in competitive markets', desc: 'In competitive industries, AI citations are becoming the new page-one position. Being recommended by ChatGPT or Google AI Overviews in a competitive category gives you a visibility edge that organic rankings alone cannot replicate.', img: '/services-six-card/Seo/ai seo/Businesses in competitivemarkets.webp' },
  { icon: 'fa-solid fa-briefcase', title: 'Professional service businesses', desc: 'Lawyers, accountants, consultants, financial advisors, healthcare providers, professional services are heavily researched through AI tools before a contact decision is made. AI visibility in these categories has a direct and measurable impact on enquiry volume.', img: '/services-six-card/Seo/ai seo/Professional service businesses.webp' },
  { icon: 'fa-solid fa-truck', title: 'Local and service-area businesses', desc: 'AI platforms increasingly surface local recommendations for service queries. HVAC, plumbing, dental, legal, real estate, if your customers search locally, AI search is already part of their discovery process.', img: '/services-six-card/Seo/ai seo/Local and service-areabusinesses.webp' },
  { icon: 'fa-solid fa-server', title: 'B2B businesses and SaaS companies', desc: 'AI search adoption is highest among professional and technical buyers, the exact audience B2B businesses need to reach. Perplexity and ChatGPT are now primary research tools for procurement decisions in many industries.', img: '/services-six-card/Seo/ai seo/B2B businesses and SaaScompanies.webp' },
  { icon: 'fa-solid fa-rocket', title: 'Forward-thinking businesses that want first-mover advantage', desc: 'The vast majority of businesses in any category have not started AI SEO. The window to establish presence before competitors is open right now. Early movers compound their advantage over time as AI systems develop stronger associations with their brand.', img: '/services-six-card/Seo/ai seo/Forward-thinking businessesthat want first-moveradvantage.webp' },
];
