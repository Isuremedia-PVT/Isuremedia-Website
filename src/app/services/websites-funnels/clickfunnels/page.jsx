...
const WHO_FOR = [
  ...
  { icon: 'fa-solid fa-people-group', title: 'Agencies That Need Funnels Built for Clients', desc: 'We provide ClickFunnels design and build for agencies as part of our white-label services. Same quality, your brand, scalable across client accounts.', img: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=700&q=80' },
  { icon: 'fa-solid fa-right-left', title: 'Businesses Migrating Existing Funnels', desc: 'If you are moving from another funnel platform to ClickFunnels, we manage the migration and improve conversion architecture in the process.', img: 'https://images.unsplash.com/photo-1531482615713-2afd69097998?w=700&q=80' },
];
