...
const BENEFITS = [
  {
    ...
    desc: 'Every millisecond counts. Our landing pages are built for speed — optimised images, clean code, and lean assets that keep bounce rates low and conversions high.',
  },
  {
    icon: 'fa-solid fa-mobile-screen',
    title: 'Mobile-First Design',
    desc: 'More than half of all web traffic is mobile. We design for mobile first and scale up, so your landing page looks and converts perfectly on every device.',
  },
  {
    icon: 'fa-solid fa-arrow-trend-up',
    title: 'Conversion-Optimised Layouts',
    desc: 'From headline hierarchy to CTA placement, every element is strategically positioned based on proven conversion principles that turn visitors into leads and sales.',
  },
];
...
const PROCESS = [
  { n: '01', title: 'Strategy', desc: 'We define your target audience, primary offer, and key conversion goal before a single pixel is designed.' },
  { n: '02', title: 'Design', desc: 'Our designers craft a visually compelling, conversion-focused layout tailored to your brand and audience.' },
  { n: '03', title: 'Build', desc: 'We develop the page with clean, performant code — integrating forms, tracking, and all required tools.' },
  { n: '04', title: 'Launch', desc: 'We QA across devices, finalise analytics, and hand over a page that is ready to generate results from day one.' },
];

const RELATED = [
  { href: '/services/websites-funnels/cro', icon: 'fa-solid fa-chart-line', title: 'CRO & Optimisation', desc: 'Squeeze more conversions from your existing traffic with data-driven CRO audits and A/B testing.' },
  { href: '/services/websites-funnels/gohighlevel-funnels', icon: 'fa-solid fa-filter', title: 'GHL Funnels', desc: 'Full GoHighLevel funnel builds — from opt-in pages to automated follow-up sequences.' },
  { href: '/services/websites-funnels/wordpress-design', icon: 'fa-brands fa-wordpress', title: 'WordPress Design', desc: 'Custom WordPress websites built for speed, SEO, and seamless user experience.' },
];
      ...
      <main>
        ...
        <div style={{ background: '#fff', borderBottom: '1px solid var(--color-border)', padding: '12px 0' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <i className="fa-solid fa-chevron-right" style={{ fontSize: 9, color: 'var(--color-text-muted)' }} />
            <span style={{ fontFamily: I, fontSize: 13, color: 'var(--color-primary)', fontWeight: 500 }}>Landing Pages</span>
          </div>
        </div>
        ...
        <section style={{ background: 'var(--color-bg-soft)', padding: '104px 0', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 18px', marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: J, fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '.09em', textTransform: 'uppercase' }}>Landing Pages</span>
            </div>
            <h1 style={{ fontFamily: J, fontWeight: 900, fontSize: 'clamp(28px,3.8vw,56px)', color: 'var(--color-navy)', lineHeight: 1.1, letterSpacing: '-0.5px', marginBottom: 22, maxWidth: 820, margin: '0 auto 22px' }}>
              Landing Pages That Turn<br />Clicks Into Customers.
            </h1>
            <p style={{ fontFamily: I, fontSize: 'clamp(15px,1.2vw,18px)', color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 620, margin: '0 auto 40px' }}>
              High-converting landing pages built for lead generation and sales — fast, mobile-first, and optimised from the first pixel to the final CTA.
            </p>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, flexWrap: 'wrap' }}>
              <a href="/contact"
                ...
                Get a Landing Page <i className="fa-solid fa-arrow-right" style={{ fontSize: 11 }} />
              </a>
            ...
            <div className="split-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
              <div>
                ...
                <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,36px)', color: 'var(--color-navy)', lineHeight: 1.22, letterSpacing: '-0.4px', marginBottom: 20 }}>
                  Pages Built for One Purpose — Converting
                </h2>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 16 }}>
                  A landing page has one job: convert the visitor into a lead or a customer. Unlike a general website that invites exploration, a landing page eliminates distractions and focuses the visitor&#39;s attention on a single, compelling offer.
                </p>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 32 }}>
                  We build landing pages that combine strategic copywriting, persuasive design, and technical performance to maximise conversions for paid ads, organic campaigns, and direct outreach.
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {['Focused single-offer layout', 'Persuasive above-the-fold copy', 'Lead capture & CRM integration', 'Conversion tracking & analytics'].map(item => (
              ...
              <div style={{ position: 'relative' }}>
                ...
                <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=700&q=80" alt="Landing page conversion design" style={{ position: 'relative', zIndex: 1, width: '100%', height: 440, objectFit: 'cover', borderRadius: 16, display: 'block', boxShadow: '0 24px 64px rgba(0,35,83,.15)' }} />
              </div>
            </div>
          </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Why Our Landing Pages Outperform</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Everything Covered in Our Landing Page Service</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>How We Build Your Landing Page</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              ...
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', marginTop: 12 }}>Explore other services that complement your landing page strategy.</p>
            </div>
