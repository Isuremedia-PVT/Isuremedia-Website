...
const BENEFITS = [
  {
    ...
    title: '360° Site Diagnosis',
    desc: 'We cover every dimension of SEO health — technical, on-page, content quality, backlink profile, and site speed — in a single comprehensive report.',
  },
  {
    icon: 'fa-solid fa-chess',
    title: 'Competitor Benchmarking',
    desc: 'We audit your top 3 organic competitors alongside your site, so you can see exactly where you are falling short and where you already have an edge.',
  },
  {
    icon: 'fa-solid fa-map',
    title: 'Actionable Roadmap',
    desc: 'Every finding comes with a clear recommended action, prioritised by impact. You get a numbered action plan — not a 50-page document you will never read.',
  },
];
...
const PROCESS = [
  { n: '01', title: 'Submit Site', desc: 'You share your site URL, target keywords, and top competitors. We handle everything from there.' },
  { n: '02', title: 'Full Crawl & Analysis', desc: 'We run a comprehensive crawl and cross-reference data from Search Console, Ahrefs, and PageSpeed Insights.' },
  { n: '03', title: 'Report Delivery', desc: 'You receive a structured audit report with every finding categorised, explained, and prioritised.' },
  { n: '04', title: 'Kickoff Call', desc: 'We walk through the report with you, answer every question, and help you map out the next steps.' },
];

const RELATED = [
  { href: '/services/seo/technical-seo', icon: 'fa-solid fa-screwdriver-wrench', title: 'Technical SEO', desc: 'After the audit, we fix every technical issue found — from crawl errors to Core Web Vitals.' },
  { href: '/services/seo/on-page-seo', icon: 'fa-solid fa-file-lines', title: 'On-Page SEO', desc: 'Act on your audit findings with page-by-page optimisation of content, metadata, and structure.' },
  { href: '/services/seo/link-building', icon: 'fa-solid fa-link', title: 'Link Building', desc: 'Use the backlink gap insights from your audit to build a targeted link acquisition strategy.' },
];
      ...
      <main>
        ...
        <div style={{ background: '#fff', borderBottom: '1px solid var(--color-border)', padding: '12px 0' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <i className="fa-solid fa-chevron-right" style={{ fontSize: 9, color: 'var(--color-text-muted)' }} />
            <span style={{ fontFamily: I, fontSize: 13, color: 'var(--color-primary)', fontWeight: 500 }}>SEO Audits</span>
          </div>
        </div>
        ...
        <section style={{ background: 'var(--color-bg-soft)', padding: '104px 0', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 18px', marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: J, fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '.09em', textTransform: 'uppercase' }}>SEO Audits</span>
            </div>
            <h1 style={{ fontFamily: J, fontWeight: 900, fontSize: 'clamp(28px,3.8vw,56px)', color: 'var(--color-navy)', lineHeight: 1.1, letterSpacing: '-0.5px', marginBottom: 22, maxWidth: 820, margin: '0 auto 22px' }}>
              Your SEO Audit Is the Starting<br />Point for Every Win
            </h1>
            <p style={{ fontFamily: I, fontSize: 'clamp(15px,1.2vw,18px)', color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 680, margin: '0 auto 40px' }}>
              A full-stack SEO audit covering technical health, on-page factors, backlink profile, and competitor gaps — with a clear action plan.
            </p>
            ...
            <div className="split-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
              <div>
                ...
                <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,36px)', color: 'var(--color-navy)', lineHeight: 1.22, letterSpacing: '-0.4px', marginBottom: 20 }}>
                  A Complete Picture of Where You Stand and What to Do Next
                </h2>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 16 }}>
                  An SEO audit is a comprehensive review of your website&#39;s performance across every dimension that affects organic rankings. Without one, you are making strategy decisions without knowing what is actually holding you back.
                </p>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 32 }}>
                  Our audits cover technical health, on-page content quality, backlink profile strength, Core Web Vitals performance, keyword gaps, and competitor positioning. Every finding is ranked by the impact it will have on your rankings, and every recommendation comes with a clear implementation guide.
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {['Technical health & crawlability review', 'On-page content & metadata analysis', 'Backlink profile & authority assessment', 'Keyword gap & competitor benchmarking'].map(item => (
              ...
              <div style={{ position: 'relative' }}>
                ...
                <img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=700&q=80" alt="SEO audit data analysis" style={{ position: 'relative', zIndex: 1, width: '100%', height: 440, objectFit: 'cover', borderRadius: 16, display: 'block', boxShadow: '0 24px 64px rgba(0,35,83,.15)' }} />
              </div>
            </div>
          </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Why Every SEO Campaign Starts With an Audit</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Everything Covered in Our SEO Audit</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>How We Deliver Your SEO Audit</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              ...
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', marginTop: 12 }}>Act on your audit findings with these services.</p>
            </div>
