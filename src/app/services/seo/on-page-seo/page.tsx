...
const BENEFITS = [
  {
    ...
    title: 'Higher CTR from Search',
    desc: 'Compelling title tags and meta descriptions increase the percentage of searchers who click through to your site — more visibility, more traffic.',
  },
  {
    icon: 'fa-solid fa-crosshairs',
    title: 'Better Keyword Targeting',
    desc: 'We map the right keywords to the right pages so Google understands exactly what each page is about and who it should rank it for.',
  },
  {
    icon: 'fa-solid fa-user-check',
    title: 'Improved User Experience',
    desc: 'Clear heading structure, fast-loading pages, and well-organised content keep visitors engaged and reduce bounce rate — both signals Google measures.',
  },
];

const INCLUDED = [
  'Keyword mapping per page',
  'Title tag & meta description writing',
  'Heading structure (H1–H3) optimisation',
  'Content optimisation for relevance',
...
const PROCESS = [
  { n: '01', title: 'Audit', desc: 'We audit every page — metadata, content quality, heading usage, and internal links to identify gaps.' },
  { n: '02', title: 'Keyword Map', desc: 'We assign target keywords to each page based on intent, competition, and business priority.' },
  { n: '03', title: 'Optimise', desc: 'Our team rewrites and refines every on-page element to align with keyword targets and user intent.' },
  { n: '04', title: 'Track', desc: 'We monitor keyword rankings and organic traffic to measure impact and continue improving.' },
];

const RELATED = [
  { href: '/services/seo/technical-seo', icon: 'fa-solid fa-screwdriver-wrench', title: 'Technical SEO', desc: 'Fix crawl issues, speed, and site architecture so your on-page work can actually rank.' },
  ...
  { href: '/services/seo/local-seo', icon: 'fa-solid fa-location-dot', title: 'Local SEO', desc: 'Dominate local search results with GBP optimisation, citations, and local content.' },
];
      ...
      <main>
        ...
        <div style={{ background: '#fff', borderBottom: '1px solid var(--color-border)', padding: '12px 0' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <i className="fa-solid fa-chevron-right" style={{ fontSize: 9, color: 'var(--color-text-muted)' }} />
            <span style={{ fontFamily: I, fontSize: 13, color: 'var(--color-primary)', fontWeight: 500 }}>On-Page SEO</span>
          </div>
        </div>
        ...
        <section style={{ background: 'var(--color-bg-soft)', padding: '104px 0', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 18px', marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: J, fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '.09em', textTransform: 'uppercase' }}>On-Page SEO</span>
            </div>
            <h1 style={{ fontFamily: J, fontWeight: 900, fontSize: 'clamp(28px,3.8vw,56px)', color: 'var(--color-navy)', lineHeight: 1.1, letterSpacing: '-0.5px', marginBottom: 22, maxWidth: 820, margin: '0 auto 22px' }}>
              On-Page SEO That Makes Every<br />Page a Ranking Asset
            </h1>
            <p style={{ fontFamily: I, fontSize: 'clamp(15px,1.2vw,18px)', color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 620, margin: '0 auto 40px' }}>
              Page-by-page optimisation of content, metadata, structure, and internal linking for maximum organic visibility.
            </p>
            ...
            <div className="split-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
              <div>
                ...
                <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,36px)', color: 'var(--color-navy)', lineHeight: 1.22, letterSpacing: '-0.4px', marginBottom: 20 }}>
                  Signals Google Uses to Decide Who Ranks
                </h2>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 16 }}>
                  On-page SEO is the process of optimising every individual page on your site so it clearly communicates its topic, relevance, and value to both search engines and users. It covers everything from the title tag in the browser tab to the way your H2s are structured.
                </p>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 32 }}>
                  Google&#39;s algorithm reads hundreds of on-page signals when deciding where to rank a page. Content quality, keyword alignment, metadata relevance, internal link structure, and image optimisation all play a role. We make sure every signal points in the right direction.
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {['Title tag & meta description optimisation', 'Content quality & keyword alignment', 'Heading structure & semantic HTML', 'Internal linking & page authority flow'].map(item => (
              ...
              <div style={{ position: 'relative' }}>
                ...
                <img src="https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?w=700&q=80" alt="On-page SEO content strategy" style={{ position: 'relative', zIndex: 1, width: '100%', height: 440, objectFit: 'cover', borderRadius: 16, display: 'block', boxShadow: '0 24px 64px rgba(0,35,83,.15)' }} />
              </div>
            </div>
          </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Why On-Page SEO Drives Consistent Results</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Everything Covered in Our On-Page SEO Service</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>How We Deliver On-Page SEO</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              ...
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', marginTop: 12 }}>Explore other services that complement On-Page SEO.</p>
            </div>
