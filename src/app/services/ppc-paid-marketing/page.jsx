          ...
          <div className="ism-container">
            ...
            <div className="ppc-strategy-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center', marginBottom:52 }}>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:26 }}>
                {[
                  { num:'01', title:'Your buyers are searching right now', text:<>Google handles 8.5 billion searches a day. Paid search puts you at the top the same day you launch, organic rankings take months.</> },
                  { num:'02', title:'Paid clicks convert better than organic', text:<>A high-intent search click is closer to booking than a blog visitor. The intent is already there before they land.</> },
                  { num:'03', title:'You control exactly who sees your ads', text:<>Audiences, locations, timing, and spend, all adjustable in real time. No other channel gives you that level of control.</> },
                  { num:'04', title:'A bad setup wastes more than no PPC at all', text:<>Most failed campaigns were never managed properly. That gap is the difference between losing and 4–5x return.</> },
                  { num:'05', title:'Data from paid ads sharpens everything else', text:<>Every click teaches you what your buyers actually respond to. That same data makes your SEO, content, and offers better too.</> },
                ].map(item => (
            ...
            <div className="ppc-imgtext-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:56, alignItems:'center' }}>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:20 }}>
                ...
                <div style={{ marginTop:8 }}>
                  ...
                  >Get My Free PPC Audit <i className="fa-solid fa-arrow-right" style={{ fontSize:12 }} /></Link>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="ppc-split" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:60, alignItems:'center' }}>
              <div>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:16, marginBottom:36 }}>
                  <p style={{ fontFamily:I, fontSize:15, color:'rgba(255,255,255,.75)', lineHeight:1.75, margin:0 }}><strong style={{ color:'#fff', fontWeight:700 }}>The businesses that scale fastest are almost always running paid ads alongside organic growth.</strong> Paid gives you an immediate answer, with results within 48 hours, while SEO compounds in the background, and Isuremedia tracks every campaign to the revenue it produces, not impressions or clicks.</p>
                </div>
