            ...
            <div className="ppc-split" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:60, alignItems:'center' }}>
              <div>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:16, marginBottom:36 }}>
                  ...
                  <p style={{ fontFamily:I, fontSize:15, color:'rgba(255,255,255,.75)', lineHeight:1.75, margin:0 }}><strong style={{ color:'#fff', fontWeight:700 }}>Every paid channel gives you something organic growth cannot: an immediate answer.</strong> Raise your budget today and target the right buyers, and you will see results <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>within 48 hours</span> — the best testing ground for what your customers actually respond to.</p>
