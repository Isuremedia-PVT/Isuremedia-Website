...
const SERVICES = [
  ...
  { title: 'Retargeting & Remarketing', icon: 'fa-solid fa-rotate-left', desc: 'Most first-time visitors do not buy or enquire. We build retargeting campaigns across Google, Meta, and LinkedIn that show tailored ads to people who have already visited your site or watched your videos — the lowest cost per conversion of any paid channel.', href: '/services/ppc/retargeting-remarketing' },
...
const TIMELINE_STEPS = [
  ...
  { num: 4, period: 'Optimise, Test, and Improve',        desc: 'Every two weeks we run a formal optimisation pass — new negative keywords, paused underperforming variations, and more budget to what works. We also run structured A/B tests so the campaign keeps improving rather than plateauing.' },
...
const DIFFERENTIATORS = [
  ...
  { dark: false, icon: 'fa-solid fa-chart-line',   title: 'Tracking That Shows Real Revenue, Not Just Clicks',    desc: 'We set up conversion tracking that connects every campaign to actual leads and sales. You see cost per customer, not just per click — if it is not making sense, we fix it or reallocate.' },
...
const FAQS = [
  { q: 'How quickly will I see results from PPC?',                              a: 'You will see traffic the same day a campaign goes live. Meaningful lead volume usually comes within the first two to four weeks as the campaign learns. The first 30 days is partly a testing phase — campaigns typically reach their most efficient performance between months two and three.' },
        ...
        <section style={{ background:'linear-gradient(160deg,#EDF2FF 0%,#F7F8FA 48%,#FFFBEB 100%)', padding:'96px 0 64px', position:'relative', overflow:'hidden' }}>
          ...
          <div className="ism-container" style={{ textAlign:'center', position:'relative' }}>
            ...
            <p style={{ fontFamily:I, fontSize:'clamp(15px,1.6vw,18px)', color:'var(--color-text-muted)', lineHeight:1.78, maxWidth:600, margin:'0 auto 36px' }}>
              We manage Google Ads, Meta Ads, LinkedIn Ads, and retargeting campaigns for businesses that want leads and revenue from their ad spend, not just impressions — built around your cost per lead target, managed by the same in-house team from setup to results.
            </p>
          ...
          <div className="ism-container">
            ...
            <div className="ppc-strategy-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center', marginBottom:52 }}>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:26 }}>
                {[
                  { num:'01', title:'Your buyers are searching right now. The question is who shows up.', text:'Google processes over 8.5 billion searches every day. The businesses at the top of buying-search results are the ones getting the calls. Paid search puts you in those positions the same day you launch — organic rankings take months, paid ads take hours.' },
                  { num:'02', title:'50 percent of people who click a paid ad are more likely to convert than organic visitors', text:'Paid ad clicks convert at a higher rate because the intent behind the click is stronger. Someone who searched "emergency plumber near me" and clicked your ad is closer to booking than someone who found your blog post — the intent is already there before they land.' },
                  { num:'03', title:'You control exactly who sees your ads and what you pay', text:'Unlike most marketing channels, PPC gives you complete control — searches, audiences, locations, times of day, and the maximum you will pay per lead. If a campaign is not performing, you adjust or turn it off. No other channel gives you that level of accountability.' },
                  { num:'04', title:'A bad PPC setup wastes more money than no PPC at all', text:'Most businesses that give up on paid ads did not fail because PPC does not work — they failed because campaigns were set up incorrectly or nobody was managing the account after launch. The gap between a losing campaign and one returning four or five times its spend is almost entirely in setup and management.' },
                ].map(item => (
            ...
            <div style={{ textAlign:'center' }}>
              <p style={{ fontFamily:I, fontSize:15, color:'var(--color-text-muted)', lineHeight:1.75, margin:'0 auto 22px', maxWidth:560 }}>
                Isuremedia builds every paid ads campaign around one number: your cost per acquired customer. Everything else, the keywords, the audiences, the ad copy, the landing pages, is built to hit that number.
              </p>
              <a href="/contact"
            ...
            <div style={{ background:'#F5F5E6', borderRadius:24, display:'grid', gridTemplateColumns:'340px 1fr', minHeight:280, clipPath:'inset(-150px 0px 0px 0px round 24px)' }} className="ppc-cta-banner-grid">
              ...
              <div style={{ padding:'40px 52px 40px 32px', display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'flex-start' }}>
                ...
                <p style={{ fontFamily:I, fontSize:15, color:'#555', lineHeight:1.82, margin:'0 0 32px', maxWidth:460 }}>
                  Get a free PPC audit and see where your budget is leaking and what a properly managed campaign looks like.
                </p>
          ...
          <div className="ism-container">
            ...
            <div className="ppc-imgtext-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:56, alignItems:'center' }}>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:20 }}>
                <p style={{ fontFamily:I, fontSize:15, color:'var(--color-primary)', lineHeight:1.80, margin:0 }}>Every campaign we run is built around one metric — return, not clicks or impressions. We track cost per lead, cost per acquisition, and revenue per dollar spent.</p>
                <p style={{ fontFamily:I, fontSize:15, color:'var(--color-text-muted)', lineHeight:1.80, margin:0 }}>Most businesses running ads are paying too much for the wrong people. We fix that by tightening audience targeting, rewriting ad creative, and restructuring campaigns around conversion data rather than vanity metrics.</p>
                <p style={{ fontFamily:I, fontSize:15, color:'var(--color-text-muted)', lineHeight:1.80, margin:0 }}>Isuremedia manages campaigns across Google Search, Shopping, Meta, LinkedIn, YouTube, and programmatic networks — one team, one dashboard, all optimised toward the same goal.</p>
            ...
            <div className="ppc-split" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:60, alignItems:'center' }}>
              <div>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:16, marginBottom:36 }}>
                  <p style={{ fontFamily:I, fontSize:15, color:'rgba(255,255,255,.75)', lineHeight:1.75, margin:0 }}><strong style={{ color:'#fff', fontWeight:700 }}>The businesses that scale fastest are almost always running paid ads alongside organic growth.</strong> Not because PPC alone builds a business, but because it fills the gap while SEO compounds — traffic and leads today, traffic you own tomorrow.</p>
                  <p style={{ fontFamily:I, fontSize:15, color:'rgba(255,255,255,.75)', lineHeight:1.75, margin:0 }}><strong style={{ color:'#fff', fontWeight:700 }}>Every paid channel gives you something organic growth cannot: an immediate answer.</strong> Raise your budget today and target the right buyers, and you will see results within 48 hours — the best testing ground for what your customers actually respond to.</p>
                  <p style={{ fontFamily:I, fontSize:15, color:'rgba(255,255,255,.75)', lineHeight:1.75, margin:0 }}><strong style={{ color:'#fff', fontWeight:700 }}>The argument against PPC is usually the cost — but that is an argument against poorly managed paid ads, not paid ads themselves.</strong> Isuremedia tracks every campaign to the revenue it produces, not impressions or cost per click — when that number is where it needs to be, we scale; when it is not, we find out why.</p>
                  <p style={{ fontFamily:I, fontSize:15, color:'rgba(255,255,255,.75)', lineHeight:1.75, margin:0 }}><strong style={{ color:'#fff', fontWeight:700 }}>The businesses that treat paid advertising as a predictable acquisition channel are the ones that scale it consistently.</strong> That shift happens when tracking is right, campaigns are structured properly, and the team is accountable for outcomes, not just activity.</p>
                </div>
          ...
          <div style={{ background:'var(--color-primary)', borderRadius:24, padding:'60px 64px', display:'grid', gridTemplateColumns:'1fr 420px', gap:48, alignItems:'center', position:'relative', overflow:'hidden' }} className="ppc-rfr-grid">
            ...
            <div>
              ...
              <p style={{ fontFamily:I, fontSize:16, color:'rgba(255,255,255,.75)', lineHeight:1.80, margin:'0 0 36px', maxWidth:520 }}>
                Whether you are starting fresh or taking over campaigns that are burning money, the question is the same. Are the right people seeing your ads and buying? If not, talk to us and we will help you turn your ad spend into a channel that predictably brings in customers.
              </p>
