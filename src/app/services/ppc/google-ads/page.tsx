...
const BENEFITS = [
  {
    ...
    title: 'Search, Shopping & Display',
    desc: 'We manage every Google network — Search for intent, Shopping for e-commerce, Display for awareness — all under one unified strategy.',
  },
  {
    icon: 'fa-solid fa-bullseye',
    title: 'Conversion-First Bidding',
    desc: 'Smart bidding strategies anchored to your CPA or ROAS targets, not vanity metrics. Every pound works harder.',
  },
  {
    icon: 'fa-solid fa-calendar-check',
    title: 'Weekly Optimisation',
    desc: 'Ongoing A/B tests, search-term pruning, bid adjustments, and quality score improvements delivered every single week.',
  },
];

const INCLUDED = [
  'Campaign strategy & account structure',
  'Keyword research & match-type planning',
...
const STEPS = [
  { num: '01', title: 'Audit', desc: 'Deep review of your existing account or market landscape to find quick wins and structure.' },
  { num: '02', title: 'Strategy', desc: 'Campaign architecture, keyword plan, ad copy framework, and budget allocation.' },
  { num: '03', title: 'Launch', desc: 'Campaigns go live with conversion tracking confirmed and baselines established.' },
  { num: '04', title: 'Optimise', desc: 'Weekly refinements that compound over time — lower CPCs, higher CTRs, better ROAS.' },
];

const RELATED = [
  { icon: 'fa-brands fa-meta', title: 'Meta Ads', desc: 'Facebook & Instagram advertising that reaches the right audience at every funnel stage.', href: '/services/ppc/meta-ads' },
        ...
        <section style={{ background: 'var(--color-bg-soft)', padding: '100px 0', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', textAlign: 'center', position: 'relative' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 18px', marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: J, fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '.09em', textTransform: 'uppercase' }}>Google Ads Management</span>
            </div>
            <h1 style={{ fontFamily: J, fontSize: 'clamp(32px,4.5vw,62px)', fontWeight: 900, color: 'var(--color-navy)', letterSpacing: '-1px', lineHeight: 1.08, margin: '0 auto 24px', maxWidth: 860 }}>
              Google Ads That Generate Leads, Not Just Clicks
            </h1>
            <p style={{ fontFamily: I, fontSize: 18, color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 600, margin: '0 auto 44px' }}>
              Fully managed Google Ads — Search, Shopping, Display, YouTube. Optimised for conversions.
            </p>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
            <div>
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 18px', marginBottom: 24 }}>
                <span style={{ width: 7, height: 7, borderRadius: '50%', background: 'var(--color-primary)', display: 'inline-block' }} />
                <span style={{ fontFamily: J, fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '.09em', textTransform: 'uppercase' }}>What Is Google Ads?</span>
              </div>
              <h2 style={{ fontFamily: J, fontSize: 'clamp(26px,3vw,40px)', fontWeight: 900, color: 'var(--color-navy)', letterSpacing: '-0.5px', lineHeight: 1.15, marginBottom: 20 }}>
                Intent-Driven Advertising at the Moment of Search
              </h2>
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.8, marginBottom: 16 }}>
                Google Ads puts your business in front of people actively searching for what you offer. Unlike social advertising, you are not interrupting — you are answering. That intent signal makes Google Ads one of the highest-ROI channels available.
              </p>
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.8, marginBottom: 32 }}>
                But without expert management, budgets bleed fast. Poor account structure, broad match keywords, and missing negatives turn Google Ads into an expensive experiment. Our managed service handles every layer — strategy, copy, bidding, and optimisation — so your campaigns earn, not burn.
              </p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                {['Search campaigns for high-intent buyers', 'Shopping ads for e-commerce product visibility', 'Display & YouTube for brand reach at scale', 'Performance Max for full Google inventory access'].map((item, i) => (
            ...
            <div>
              <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?w=700&q=80" alt="Google Ads management" style={{ width: '100%', borderRadius: 20, boxShadow: '0 24px 72px rgba(30,77,195,.13)', display: 'block' }} />
            </div>
          </div>
        </section>
        ...
        <section style={{ padding: '100px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 64 }}>
              ...
              <h2 style={{ fontFamily: J, fontSize: 'clamp(26px,3vw,42px)', fontWeight: 900, color: 'var(--color-navy)', letterSpacing: '-0.5px', marginBottom: 16 }}>Why Our Google Ads Service Delivers</h2>
              <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', lineHeight: 1.75, maxWidth: 560, margin: '0 auto' }}>From account structure to daily bid management, we handle every detail that separates profitable campaigns from wasted spend.</p>
            </div>
        ...
        <section style={{ padding: '100px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: J, fontSize: 'clamp(26px,3vw,42px)', fontWeight: 900, color: 'var(--color-navy)', letterSpacing: '-0.5px', marginBottom: 16 }}>Everything Covered, Nothing Extra to Buy</h2>
              <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', lineHeight: 1.75, maxWidth: 560, margin: '0 auto' }}>Every engagement includes a full suite of management tasks so your campaigns are always improving.</p>
            </div>
        ...
        <section style={{ padding: '100px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 64 }}>
              ...
              <h2 style={{ fontFamily: J, fontSize: 'clamp(26px,3vw,42px)', fontWeight: 900, color: 'var(--color-navy)', letterSpacing: '-0.5px', marginBottom: 16 }}>From Zero to Profitable in Four Steps</h2>
              <p style={{ fontFamily: I, fontSize: 17, color: 'var(--color-text-muted)', lineHeight: 1.75, maxWidth: 520, margin: '0 auto' }}>A structured launch and ongoing optimisation cycle that builds momentum from day one.</p>
            </div>
        ...
        <section style={{ padding: '100px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: J, fontSize: 'clamp(26px,3vw,42px)', fontWeight: 900, color: 'var(--color-navy)', letterSpacing: '-0.5px' }}>Pair Google Ads With These Services</h2>
            </div>
