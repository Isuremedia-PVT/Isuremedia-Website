...
const BENEFITS = [
  {
    ...
    desc: 'LinkedIn, Instagram, Facebook, and TikTok each demand a different content approach. We create natively for each channel — not one size repurposed.',
  },
  {
    icon: 'fa-solid fa-microphone-lines',
    title: 'Consistent Brand Voice',
    desc: 'Every caption, graphic, and story reflects your brand identity — so your audience gets a cohesive experience no matter which platform they find you on.',
  },
  {
    icon: 'fa-solid fa-calendar-check',
    title: 'Content Calendar Management',
    desc: 'We plan, produce, and schedule your content so you never miss a posting window — freeing you to focus on running your business.',
  },
];
...
const PROCESS = [
  { n: '01', title: 'Strategy', desc: 'We audit your current presence, define content pillars, and build a platform-specific strategy.' },
  { n: '02', title: 'Design', desc: 'Our designers produce on-brand graphics and visual assets aligned to the monthly calendar.' },
  { n: '03', title: 'Schedule', desc: 'Content is copywritten, approved, and scheduled across all active platforms.' },
  { n: '04', title: 'Analyse', desc: 'We review engagement, reach, and follower growth monthly to optimise the next cycle.' },
];

const RELATED = [
  { href: '/services/content-creative/graphic-design', icon: 'fa-solid fa-pen-ruler', title: 'Graphic Design', desc: 'Brand-aligned visual design for social, ads, presentations, and marketing materials.' },
  { href: '/services/content-creative/email-marketing', icon: 'fa-solid fa-envelope-open-text', title: 'Email Marketing', desc: 'End-to-end email marketing that nurtures leads and drives revenue.' },
        ...
        <section style={{ background: 'var(--color-bg-soft)', padding: '104px 0', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 18px', marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: J, fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '.09em', textTransform: 'uppercase' }}>Social Media Content</span>
            </div>
            <h1 style={{ fontFamily: J, fontWeight: 900, fontSize: 'clamp(28px,3.8vw,56px)', color: 'var(--color-navy)', lineHeight: 1.1, letterSpacing: '-0.5px', marginBottom: 22, maxWidth: 820, margin: '0 auto 22px' }}>
              Social Media Content That Builds Brand and Drives Traffic
            </h1>
            <p style={{ fontFamily: I, fontSize: 'clamp(15px,1.2vw,18px)', color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 620, margin: '0 auto 40px' }}>
              Platform-native content strategy and production — LinkedIn, Instagram, Facebook, TikTok.
            </p>
            ...
            <div className="split-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
              <div>
                ...
                <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,36px)', color: 'var(--color-navy)', lineHeight: 1.22, letterSpacing: '-0.4px', marginBottom: 20 }}>
                  Social Media Content That Serves a Business Goal
                </h2>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 16 }}>
                  Posting for the sake of posting is the fastest way to burn your social budget. Every piece of content we create is tied to a business objective — whether that is brand awareness, lead generation, website traffic, or community engagement.
                </p>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 32 }}>
                  We manage the entire content production process — from strategy and design to copywriting and scheduling. You get a consistent, professional social presence that genuinely represents your brand and moves your audience towards action.
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {['Goal-led content strategy per platform', 'Design and copy produced in-house', 'Full calendar management and scheduling', 'Monthly reporting with actionable insights'].map(item => (
              ...
              <div style={{ position: 'relative' }}>
                ...
                <img src="https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=700&q=80" alt="Social media content creation" style={{ position: 'relative', zIndex: 1, width: '100%', height: 440, objectFit: 'cover', borderRadius: 16, display: 'block', boxShadow: '0 24px 64px rgba(0,35,83,.15)' }} />
              </div>
            </div>
          </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div className="ism-container">
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Why a Managed Social Strategy Outperforms DIY</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div className="ism-container">
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Everything in Our Social Media Content Service</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div className="ism-container">
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>How We Manage Your Social Media Content</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div className="ism-container">
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              ...
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', marginTop: 12 }}>Explore other services that complement Social Media Content.</p>
            </div>
