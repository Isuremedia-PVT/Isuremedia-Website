...
const BENEFITS = [
  {
    ...
    desc: 'Every word is written with a single goal in mind — moving visitors closer to enquiry, purchase, or sign-up through clear, persuasive messaging.',
  },
  {
    icon: 'fa-solid fa-sliders',
    title: 'Brand Voice Consistency',
    desc: 'We establish or align to your brand voice so every page sounds unmistakably like you — consistent, credible, and compelling.',
  },
  {
    icon: 'fa-solid fa-magnifying-glass',
    title: 'SEO-Compatible Copy',
    desc: 'Copy is crafted to satisfy both readers and search engines — keywords placed naturally within persuasive, well-structured content.',
  },
];

const INCLUDED = [
  'Brand voice audit & guidelines',
...
const PROCESS = [
  { n: '01', title: 'Discovery', desc: 'We learn your business, audience, competitors, and goals through a structured kickoff process.' },
  { n: '02', title: 'Messaging', desc: 'We develop your core messaging framework — value propositions, differentiators, and tone of voice.' },
  { n: '03', title: 'Write', desc: 'Our copywriters produce page-by-page copy aligned to the messaging framework and conversion goals.' },
  { n: '04', title: 'Refine', desc: 'You review, we revise. Every page is refined until the copy is exactly right.' },
];

const RELATED = [
  { href: '/services/content-creative/seo-blog-writing', icon: 'fa-solid fa-newspaper', title: 'SEO Blog Writing', desc: 'Long-form SEO articles that rank, build authority, and drive organic traffic.' },
  { href: '/services/content-creative/ad-creative-design', icon: 'fa-solid fa-rectangle-ad', title: 'Ad Creative Design', desc: 'High-performance visual ad creative designed to stop the scroll and drive clicks.' },
  { href: '/services/websites-funnels/cro', icon: 'fa-solid fa-chart-line', title: 'CRO', desc: 'Conversion rate optimisation that turns more of your existing traffic into customers.' },
];
      ...
      <main>
        ...
        <div style={{ background: '#fff', borderBottom: '1px solid var(--color-border)', padding: '12px 0' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <i className="fa-solid fa-chevron-right" style={{ fontSize: 9, color: 'var(--color-text-muted)' }} />
            <span style={{ fontFamily: I, fontSize: 13, color: 'var(--color-primary)', fontWeight: 500 }}>Website Copywriting</span>
          </div>
        </div>
        ...
        <section style={{ background: 'var(--color-bg-soft)', padding: '104px 0', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 18px', marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: J, fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '.09em', textTransform: 'uppercase' }}>Website Copywriting</span>
            </div>
            <h1 style={{ fontFamily: J, fontWeight: 900, fontSize: 'clamp(28px,3.8vw,56px)', color: 'var(--color-navy)', lineHeight: 1.1, letterSpacing: '-0.5px', marginBottom: 22, maxWidth: 820, margin: '0 auto 22px' }}>
              Website Copy That Convinces, Converts, and Closes
            </h1>
            <p style={{ fontFamily: I, fontSize: 'clamp(15px,1.2vw,18px)', color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 620, margin: '0 auto 40px' }}>
              Strategic website copywriting for homepages, service pages, and landing pages that do the selling for you.
            </p>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, flexWrap: 'wrap' }}>
              <a href="/contact"
                ...
                Get Copywriting Quote <i className="fa-solid fa-arrow-right" style={{ fontSize: 11 }} />
              </a>
            ...
            <div className="split-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
              <div>
                ...
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 16 }}>
                  Most businesses have website copy — but very few have website copy that actually works. The difference lies in strategy. Conversion copywriting starts with understanding what your audience fears, wants, and needs — then crafting language that speaks directly to that and guides them towards action.
                </p>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 32 }}>
                  Our copywriters combine direct response principles with brand strategy. The result is a website that builds trust, communicates your unique value, and converts visitors into enquiries at a measurably higher rate.
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {['Direct response copywriting principles', 'Audience-first messaging strategy', 'Hierarchy of claims and proof', 'CTA architecture that drives action'].map(item => (
              ...
              <div style={{ position: 'relative' }}>
                ...
                <img src="https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=700&q=80" alt="Website copywriting at work" style={{ position: 'relative', zIndex: 1, width: '100%', height: 440, objectFit: 'cover', borderRadius: 16, display: 'block', boxShadow: '0 24px 64px rgba(0,35,83,.15)' }} />
              </div>
            </div>
          </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Why Strategic Copy Makes Every Page Work Harder</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Everything in Our Website Copywriting Service</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>How We Deliver Website Copywriting</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              ...
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', marginTop: 12 }}>Explore other services that work alongside Website Copywriting.</p>
            </div>
