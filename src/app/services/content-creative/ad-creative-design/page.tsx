...
const BENEFITS = [
  {
    ...
    desc: 'We produce every asset in the exact dimensions and specs required for Meta, Google Display, TikTok, and YouTube — no cropping, no compromise.',
  },
  {
    icon: 'fa-solid fa-arrow-pointer',
    title: 'Direct Response Focused',
    desc: 'Every creative is built around a single conversion goal — click, lead, purchase. Design and copy work together to drive the action that matters.',
  },
  {
    icon: 'fa-solid fa-gauge-high',
    title: 'Fast Production Pipeline',
    desc: 'Campaign-ready creative in days, not weeks. Our production process is optimised for the pace of paid media — so you can test and scale faster.',
  },
];

const INCLUDED = [
  'Creative strategy brief',
  'Static ad sets (multiple sizes)',
  'Animated / GIF ad variants',
  'Video ad concepts & storyboards',
  'Multiple size variants per format',
  'Copy testing variants',
  'Brand compliance check',
  'Campaign-ready file exports',
];

const PROCESS = [
  { n: '01', title: 'Brief', desc: 'We align on campaign goals, audience, offer, and platform requirements before a single pixel is produced.' },
  { n: '02', title: 'Concepts', desc: 'Multiple creative concepts are developed with distinct angles — so you can test what resonates with your audience.' },
  { n: '03', title: 'Produce', desc: 'Approved concepts are produced in all required formats and sizes, with copy variants for A/B testing.' },
  { n: '04', title: 'Deliver', desc: 'Campaign-ready files are packaged and delivered with a naming convention aligned to your ad account structure.' },
];

const RELATED = [
  { href: '/services/content-creative/graphic-design', icon: 'fa-solid fa-pen-ruler', title: 'Graphic Design', desc: 'Brand-aligned visual design for social, presentations, and all marketing materials.' },
  { href: '/services/ppc/meta-ads', icon: 'fa-brands fa-meta', title: 'Meta Ads', desc: 'Full-funnel Meta advertising strategy and management that drives measurable ROAS.' },
  { href: '/services/ppc/google-ads', icon: 'fa-brands fa-google', title: 'Google Ads', desc: 'Intent-led Google Ads campaigns that put your brand in front of ready-to-buy audiences.' },
];
      ...
      <main>
        ...
        <div style={{ background: '#fff', borderBottom: '1px solid var(--color-border)', padding: '12px 0' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <a href="/services/content-creative" style={{ fontFamily: I, fontSize: 13, color: 'var(--color-text-muted)', textDecoration: 'none' }}>Content &amp; Creative</a>
            <i className="fa-solid fa-chevron-right" style={{ fontSize: 9, color: 'var(--color-text-muted)' }} />
            <span style={{ fontFamily: I, fontSize: 13, color: 'var(--color-primary)', fontWeight: 500 }}>Ad Creative Design</span>
          </div>
        </div>
        ...
        <section style={{ background: 'var(--color-bg-soft)', padding: '104px 0', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 18px', marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: J, fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '.09em', textTransform: 'uppercase' }}>Ad Creative Design</span>
            </div>
            ...
            <p style={{ fontFamily: I, fontSize: 'clamp(15px,1.2vw,18px)', color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 620, margin: '0 auto 40px' }}>
              High-performance visual ad creative for Meta, Google Display, TikTok, and YouTube — designed to convert.
            </p>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, flexWrap: 'wrap' }}>
              <a href="/contact"
                ...
                Get Ad Creative Samples <i className="fa-solid fa-arrow-right" style={{ fontSize: 11 }} />
              </a>
            ...
            <div className="split-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
              <div>
                ...
                <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,36px)', color: 'var(--color-navy)', lineHeight: 1.22, letterSpacing: '-0.4px', marginBottom: 20 }}>
                  Why Ad Creative Is the #1 Lever for Paid Performance
                </h2>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 16 }}>
                  In a world of increasingly efficient ad platforms, the creative is the differentiator. Facebook and Google&#39;s algorithms are good at finding your audience — but they can only work with what you give them. Great creative earns lower CPMs, higher CTRs, and better conversion rates across every campaign.
                </p>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 32 }}>
                  We produce ad creative that is built for performance, not just aesthetics. Every asset has a clear visual hierarchy, a compelling hook, and a direct call to action — designed for the split-second attention window of a social feed or display network.
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {['Hook-first creative that earns the click', 'Platform-native formats and specs', 'Copy and creative aligned to campaign stage', 'Volume built for proper creative testing'].map(item => (
              ...
              <div style={{ position: 'relative' }}>
                ...
                <img src="https://images.unsplash.com/photo-1561070791-2526d30994b5?w=700&q=80" alt="Ad creative design work" style={{ position: 'relative', zIndex: 1, width: '100%', height: 440, objectFit: 'cover', borderRadius: 16, display: 'block', boxShadow: '0 24px 64px rgba(0,35,83,.15)' }} />
              </div>
            </div>
          </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Why Performance Creative Changes Campaign Results</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Everything in Our Ad Creative Design Service</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>How We Produce Ad Creative</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              ...
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', marginTop: 12 }}>Explore other services that complement Ad Creative Design.</p>
            </div>
