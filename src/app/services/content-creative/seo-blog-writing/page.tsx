...
const BENEFITS = [
  {
    ...
    title: 'Keyword-Optimised from Research',
    desc: 'Every article starts with deep keyword research — targeting terms with real search intent and commercial value, not just volume.',
  },
  {
    icon: 'fa-solid fa-award',
    title: 'E-E-A-T Compliant Content',
    desc: 'We write with Experience, Expertise, Authoritativeness, and Trust built in — the signals Google prioritises in content quality evaluation.',
  },
  {
    icon: 'fa-solid fa-diagram-project',
    title: 'Internal Linking Strategy',
    desc: 'Each article is mapped into your site architecture with strategic internal links that distribute authority and improve crawl depth.',
  },
];
...
const INCLUDED = [
  ...
  '1000–2500 word article',
  'SEO metadata (title + description)',
  'Internal links mapped & placed',
  'Images sourced & alt-tagged',
  'CTA placement & optimisation',
  'One revision round included',
];

const PROCESS = [
  { n: '01', title: 'Research', desc: 'We identify high-value keyword targets, analyse SERP intent, and map competitor content gaps.' },
  { n: '02', title: 'Brief', desc: 'A detailed content brief is produced covering angle, structure, keywords, and word count.' },
  { n: '03', title: 'Write', desc: 'Our specialist writers produce the article, weaving in keywords naturally without compromising readability.' },
  { n: '04', title: 'Optimise', desc: 'We apply on-page SEO, add internal links, source images, and prepare publish-ready files.' },
];
      ...
      <main>
        ...
        <div style={{ background: '#fff', borderBottom: '1px solid var(--color-border)', padding: '12px 0' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <i className="fa-solid fa-chevron-right" style={{ fontSize: 9, color: 'var(--color-text-muted)' }} />
            <span style={{ fontFamily: I, fontSize: 13, color: 'var(--color-primary)', fontWeight: 500 }}>SEO Blog Writing</span>
          </div>
        </div>
        ...
        <section style={{ background: 'var(--color-bg-soft)', padding: '104px 0', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 18px', marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: J, fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '.09em', textTransform: 'uppercase' }}>SEO Blog Writing</span>
            </div>
            <h1 style={{ fontFamily: J, fontWeight: 900, fontSize: 'clamp(28px,3.8vw,56px)', color: 'var(--color-navy)', lineHeight: 1.1, letterSpacing: '-0.5px', marginBottom: 22, maxWidth: 820, margin: '0 auto 22px' }}>
              SEO Blog Writing That Ranks, Converts, and Builds Authority
            </h1>
            <p style={{ fontFamily: I, fontSize: 'clamp(15px,1.2vw,18px)', color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 620, margin: '0 auto 40px' }}>
              Researched, optimised blog content written by SEO specialists — not content mills.
            </p>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, flexWrap: 'wrap' }}>
              <a href="/contact"
                ...
                Get Blog Writing Sample <i className="fa-solid fa-arrow-right" style={{ fontSize: 11 }} />
              </a>
            ...
            <div className="split-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
              <div>
                ...
                <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,36px)', color: 'var(--color-navy)', lineHeight: 1.22, letterSpacing: '-0.4px', marginBottom: 20 }}>
                  What Great SEO Blog Writing Actually Looks Like
                </h2>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 16 }}>
                  Most blog content fails because it starts with a topic rather than a strategy. Great SEO blog writing begins with understanding what your audience is searching for, what intent sits behind that query, and what it takes to rank in the SERP — then writing content that satisfies both the reader and the algorithm.
                </p>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 32 }}>
                  Our SEO writers are not generalists — they are trained in keyword strategy, search intent mapping, and on-page optimisation. Every article we produce is built to rank, drive qualified traffic, and position your brand as a genuine authority in its space.
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {['Search intent-led article strategy', 'Long-form content that earns topical authority', 'Written to E-E-A-T standards for credibility', 'Optimised headings, metadata, and structure'].map(item => (
              ...
              <div style={{ position: 'relative' }}>
                ...
                <img src="https://images.unsplash.com/photo-1455390582262-044cdead277a?w=700&q=80" alt="SEO blog writing" style={{ position: 'relative', zIndex: 1, width: '100%', height: 440, objectFit: 'cover', borderRadius: 16, display: 'block', boxShadow: '0 24px 64px rgba(0,35,83,.15)' }} />
              </div>
            </div>
          </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Why Our SEO Blog Writing Delivers Results</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Everything in Our SEO Blog Writing Service</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>How We Deliver SEO Blog Content</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              ...
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', marginTop: 12 }}>Explore other services that complement SEO Blog Writing.</p>
            </div>
