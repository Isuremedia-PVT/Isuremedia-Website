...
const BENEFITS = [
  {
    ...
    title: 'NDA-Protected Builds',
    desc: 'Every project is covered by a full NDA. We build under your agency brand and never contact your clients directly — your relationships stay yours.',
  },
  {
    icon: 'fa-solid fa-pencil-ruler',
    title: 'Pixel-Perfect Delivery',
    desc: 'We obsess over the details. Every site we deliver is design-accurate, cross-browser tested, and fully responsive before it reaches your clients.',
  },
  {
    icon: 'fa-solid fa-comments',
    title: 'Regular Project Updates',
    desc: 'We keep your agency informed with structured project updates at each milestone, so you always know exactly where each build stands.',
  },
];
...
const PROCESS = [
  { n: '01', title: 'Brief', desc: 'We take a comprehensive brief from your agency — client brand guidelines, functionality requirements, platform preference, and timeline.' },
  { n: '02', title: 'Wireframe', desc: 'We produce wireframes and design mockups for your agency to review and approve before any development begins.' },
  { n: '03', title: 'Build', desc: 'Our developers build the site to spec — clean code, optimised for speed, with all plugins and integrations configured.' },
  { n: '04', title: 'QA & Deliver', desc: 'Full QA across devices, browsers, and screen sizes before handover. We provide documentation your clients can use immediately.' },
];

const RELATED = [
  { href: '/services/white-label', icon: 'fa-solid fa-building', title: 'White-Label Hub', desc: 'Explore the full range of white-label services your agency can resell under your brand.' },
  { href: '/services/white-label/white-label-content', icon: 'fa-solid fa-pen-nib', title: 'White-Label Content', desc: 'Pair your web builds with SEO-optimised content delivered under your agency brand.' },
  { href: '/services/websites-funnels', icon: 'fa-solid fa-globe', title: 'Websites & Funnels', desc: 'Direct web design and funnel builds for your own business — not white-labelled.' },
];
      ...
      <main>
        ...
        <div style={{ background: '#fff', borderBottom: '1px solid var(--color-border)', padding: '12px 0' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <i className="fa-solid fa-chevron-right" style={{ fontSize: 9, color: 'var(--color-text-muted)' }} />
            <span style={{ fontFamily: I, fontSize: 13, color: 'var(--color-primary)', fontWeight: 500 }}>White-Label Web Design</span>
          </div>
        </div>
        ...
        <section style={{ background: 'var(--color-bg-soft)', padding: '104px 0', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 18px', marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: J, fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '.09em', textTransform: 'uppercase' }}>White-Label Web Design</span>
            </div>
            <h1 style={{ fontFamily: J, fontWeight: 900, fontSize: 'clamp(28px,3.8vw,56px)', color: 'var(--color-navy)', lineHeight: 1.1, letterSpacing: '-0.5px', marginBottom: 22, maxWidth: 820, margin: '0 auto 22px' }}>
              WordPress, Shopify &amp; GHL Sites.<br />Built Under Your Brand.
            </h1>
            <p style={{ fontFamily: I, fontSize: 'clamp(15px,1.2vw,18px)', color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 620, margin: '0 auto 40px' }}>
              White-label web design and development — pixel-perfect builds on WordPress, Shopify, and GoHighLevel delivered under your agency name with full NDA protection.
            </p>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, flexWrap: 'wrap' }}>
              <a href="/contact"
                ...
                Start a White-Label Build <i className="fa-solid fa-arrow-right" style={{ fontSize: 11 }} />
              </a>
            ...
            <div className="split-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 72, alignItems: 'center' }}>
              <div>
                ...
                <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,36px)', color: 'var(--color-navy)', lineHeight: 1.22, letterSpacing: '-0.4px', marginBottom: 20 }}>
                  Sell Web Design. We Build It.
                </h2>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 16 }}>
                  White-label web design gives your agency the ability to sell professional WordPress, Shopify, and GoHighLevel website builds without maintaining a development team. We deliver the completed site — you present it to your client.
                </p>
                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.82, marginBottom: 32 }}>
                  From initial wireframe to final handover, every stage of the project is managed by our team and communicated to you — so you stay in control of your client relationship without doing the technical work.
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {['WordPress, Shopify, and GHL builds', 'Custom UI/UX design included', 'Speed & mobile optimised as standard', 'Full handover with documentation'].map(item => (
              ...
              <div style={{ position: 'relative' }}>
                ...
                <img src="https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=700&q=80" alt="Web design and development" style={{ position: 'relative', zIndex: 1, width: '100%', height: 440, objectFit: 'cover', borderRadius: 16, display: 'block', boxShadow: '0 24px 64px rgba(0,35,83,.15)' }} />
              </div>
            </div>
          </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Why Agencies Use Our White-Label Web Design</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>Everything Covered in Our White-Label Web Design Service</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>How We Build &amp; Deliver Your White-Label Sites</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              ...
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', marginTop: 12 }}>Explore other services that complement white-label web design.</p>
            </div>
