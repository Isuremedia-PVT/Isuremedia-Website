        ...
        <section className="wl-hero" style={{ background:'linear-gradient(160deg,#EDF2FF 0%,#F7F8FA 48%,#FFFBEB 100%)', padding:'96px 0 64px', position:'relative', overflow:'hidden' }}>
          ...
          <div style={{ maxWidth:1280, margin:'0 auto', padding:'0 24px', textAlign:'center', position:'relative' }}>
            ...
            <p style={{ fontFamily:I, fontSize:'clamp(15px,1.6vw,18px)', color:'var(--color-text-muted)', lineHeight:1.78, maxWidth:560, margin:'0 auto 36px' }}>
              We are the in-house team your agency does not have to hire. Isuremedia delivers SEO, PPC, web development, GoHighLevel setup, content marketing, graphic design, and more, completely under your agency brand. Your clients deal with you — we handle the delivery, with no footprint anywhere your clients can see.
            </p>
          ...
          <div style={{ maxWidth:1200, margin:'0 auto', padding:'0 28px' }}>
            ...
            <div className="wl-strategy-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center', marginBottom:52 }}>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:26 }}>
                {[
                  { num:'01', title:'Most agencies lose profitable clients because they cannot deliver the services the client needs', text:'An agency limited by its own headcount either says no when a client asks for SEO and loses the account, or scrambles to find a freelancer and hopes for the best. White-label fulfillment means the answer is always yes, delivered properly, by specialists.' },
                  { num:'02', title:'Hiring is the most expensive and slowest way to add service capacity', text:'A senior SEO specialist costs upwards of $80,000 a year before benefits and the months it takes to get them productive. A white-label partnership adds the same capacity immediately, scales with your client load, and stops when you need it to.' },
                  { num:'03', title:'Agency profit margins shrink when fulfilment costs scale with revenue', text:'The agencies with the strongest margins keep overhead lean and use white-label partners for delivery. When fulfilment is variable rather than fixed, every new client adds revenue without a proportional cost — that is how agencies scale without burning out.' },
                  { num:'04', title:'Your clients trust your agency brand, not the tools or contractors behind it', text:'The agency relationship is built on trust in you and your name. As long as the work is delivered well, your clients do not need to know how you produce it. White-label fulfillment lets you deliver enterprise-level work without an enterprise-level team.' },
                ].map(item => (
              ...
              <div>
                ...
                <div style={{ display:'flex', flexDirection:'column', gap:16, marginBottom:36 }}>
                  <p style={{ fontFamily:I, fontSize:15, color:'rgba(255,255,255,.75)', lineHeight:1.75, margin:0 }}>
                    <strong style={{ color:'#fff', fontWeight:700 }}>Isuremedia works as the silent delivery arm for agencies who want to offer more without hiring more.</strong> Your strategy, your client relationships, our execution — every deliverable carries your brand.
                  </p>
                  <p style={{ fontFamily:I, fontSize:15, color:'rgba(255,255,255,.75)', lineHeight:1.75, margin:0 }}>
                    <strong style={{ color:'#fff', fontWeight:700 }}>The agencies that grow fastest are not always the ones with the biggest internal teams.</strong> They are the ones that have worked out how to deliver more, consistently, without the overhead holding back the margin.
                  </p>
                </div>
          ...
          <div style={{ maxWidth:1200, margin:'0 auto', background:'var(--color-primary)', borderRadius:24, padding:'60px 64px', display:'grid', gridTemplateColumns:'1fr 420px', gap:48, alignItems:'center', position:'relative', overflow:'hidden' }} className="wl-rfr-grid">
            ...
            <div>
              ...
              <p style={{ fontFamily:I, fontSize:16, color:'rgba(255,255,255,.75)', lineHeight:1.80, margin:'0 0 36px', maxWidth:520 }}>
                Whether you are a solo consultant, a growing agency, or an established firm that keeps turning down work it cannot deliver, the question is the same. Are you getting the revenue your agency is capable of? If not, talk to us and we will help you deliver more services, win bigger clients, and grow without the overhead.
              </p>
