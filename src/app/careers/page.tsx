    ...
    <>
      ...
      <main>
        ...
        <section style={{ background: 'linear-gradient(135deg, #EEF2FF 0%, #E8EFFF 50%, #EEF2FF 100%)', padding: '52px 0 60px', position: 'relative', overflow: 'hidden' }}>
          ...
          <div className="car-container" style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
            <div className="car-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 56, alignItems: 'center', minHeight: 500 }}>

              {/* LEFT */}
              <div>
                <h1 style={{ fontFamily: J, fontWeight: 900, fontSize: 'clamp(28px,3.4vw,52px)', color: 'var(--color-navy)', lineHeight: 1.08, letterSpacing: '-0.5px', marginBottom: 22 }}>
                  Come do <span style={{ color: 'var(--color-primary)' }}>real work</span> on global accounts with a team that is{' '}
                  <span style={{ color: 'var(--color-primary)' }}>genuinely good</span> at what it does.
                </h1>

                <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 480, marginBottom: 36 }}>
                  We work with businesses and agencies across the US, UK, and India — covering SEO, paid media, web, content, and automation. If you want to build your career on real accounts with real outcomes, read on.
                </p>
          ...
          <style>{`
            @media (max-width: 900px) { .car-hero-grid { grid-template-columns: 1fr !important; min-height: unset !important; gap: 40px !important; } }
            @media (max-width: 768px) { .car-container { padding: 0 20px !important; } .car-hero-btns { flex-direction: column !important; align-items: flex-start !important; } }
          `}</style>
        </section>
        ...
        <section style={{ background: '#F7F8FA', padding: '96px 0 112px' }}>
          ...
          <style>{`
            @media (max-width: 900px) { .car-grow-grid { grid-template-columns: repeat(2,1fr) !important; } }
            @media (max-width: 560px) { .car-grow-grid { grid-template-columns: 1fr !important; } }
          `}</style>
        </section>

        {/* ══ 04. IMAGE CAROUSEL — full bleed + floating card ══════════════ */}
        <section style={{ position: 'relative', height: 580, overflow: 'hidden', background: '#0D1B3E' }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            key={slideIdx}
          ...
          <div style={{ position: 'absolute', bottom: 40, left: 0, right: 0, pointerEvents: 'none' }}>
            <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px' }}>
          <div style={{ width: 360, background: '#fff', borderRadius: 20, padding: '28px 32px', boxShadow: '0 24px 64px rgba(0,0,0,.22)', opacity: slideFading ? 0 : 1, transition: 'opacity .3s ease', pointerEvents: 'all' }}>
        ...
        <section style={{ background: '#fff', padding: '96px 0 104px' }}>
          ...
          <style>{`
            @media (max-width: 900px) { .car-mosaic-row1 { grid-template-columns: 1fr 1fr !important; } .car-mosaic-row2 { grid-template-columns: 1fr !important; } }
        ...
        <section id="apply" ref={formRef as React.RefObject<HTMLElement>} style={{ padding: '96px 0 112px', background: '#fff' }}>
          ...
          <style>{`
            @media (max-width: 900px) { .car-form-grid { grid-template-columns: 1fr !important; gap: 48px !important; } .car-form-grid > div:first-child { position: relative !important; top: 0 !important; } }
            @media (max-width: 600px) { .car-row2 { grid-template-columns: 1fr !important; } }
          `}</style>
        </section>
        ...
        <section style={{ padding: '88px 0', background: '#fff' }}>
            ...
            <div className="car-cta-card" style={{ position: 'relative', background: 'var(--color-primary)', borderRadius: 24, padding: '56px 60px', display: 'grid', gridTemplateColumns: '1fr 380px', alignItems: 'center', gap: 56, overflow: 'hidden' }}>
              ...
              <div style={{ position: 'relative', zIndex: 2 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
                  ...
                  <span style={{ fontFamily: J, fontSize: 11, fontWeight: 700, color: 'rgba(255,255,255,.75)', letterSpacing: '.12em', textTransform: 'uppercase' }}>Stay Connected</span>
                </div>
                ...
                <p style={{ fontFamily: I, fontSize: 16, color: 'rgba(255,255,255,.85)', lineHeight: 1.78, maxWidth: 560, marginBottom: 36 }}>
                  Follow us on LinkedIn for updates on new openings, team news, and work we are doing across digital marketing. We share content worth reading for anyone building a serious career in this industry.
                </p>
          ...
          <style>{`
            @media (max-width: 900px) { .car-cta-card { grid-template-columns: 1fr !important; } .car-cta-card img { height: 240px !important; } }
