...
const STATS = [
  { num: '5×',  label: 'More listing inquiries'    },
  { num: '45%', label: 'Lower cost-per-lead'        },
  { num: '90',  label: 'Days to ranking results'    },
];

const WHAT_WE_DO = [
  {
    icon: 'fa-solid fa-map-location-dot',
    title: 'Local SEO for Real Estate Keywords',
    desc: 'We optimise your website and Google Business Profile for neighbourhood-level searches like "homes for sale in [city]" and "top real estate agent near me" — driving consistent organic leads from buyers and sellers in your market.',
  },
  {
    icon: 'fa-solid fa-magnifying-glass',
    title: 'Google Ads for Buyer & Seller Intent',
    desc: 'Targeted search campaigns capturing high-intent queries like "sell my home fast" and "new listings in [area]" — with dedicated landing pages and call tracking that turn clicks into conversations.',
  },
  {
    icon: 'fa-solid fa-bullhorn',
    title: 'Facebook Lead Ads',
    desc: 'Facebook and Instagram lead generation campaigns targeting homebuyers, sellers, and investors by location, age, life event, and interest — with instant lead forms that capture contact details without leaving the app.',
  },
  {
    icon: 'fa-solid fa-house-laptop',
    title: 'Landing Pages with IDX Integration',
    desc: 'High-converting property search landing pages with live IDX feeds, neighbourhood guides, and CTA flows that capture buyer leads and route them directly into your CRM.',
  },
  {
    icon: 'fa-solid fa-robot',
    title: 'CRM Automation for Follow-Up',
    desc: 'GoHighLevel CRM setup with automated follow-up sequences for new buyer leads, seller inquiries, and open house attendees — so no lead falls through the cracks and you stay top of mind until they are ready to move.',
  },
];
...
const PROCESS = [
  { n: '01', title: 'Market Research',    desc: 'We audit your local market, competitor rankings, and current digital footprint to identify the fastest path to more inquiries in your area.' },
  { n: '02', title: 'Campaign Build',     desc: 'We build your SEO strategy, set up Google and Facebook campaigns, create landing pages, and configure your CRM automation before anything goes live.' },
  { n: '03', title: 'Launch',             desc: 'Everything launches together — ads, SEO actions, and automation flows — with conversion tracking in place from day one so we know what is working.' },
  { n: '04', title: 'Nurture',            desc: 'Automated follow-up sequences keep every lead warm, book appointments, and re-engage cold prospects — so your pipeline stays full even when you are busy closing.' },
];

const RELATED = [
  { href: '/services/seo/local-seo',                  icon: 'fa-solid fa-map-location-dot', title: 'Local SEO',     desc: 'Rank for neighbourhood and city-level searches that bring buyers and sellers to your door.' },
  { href: '/services/ppc/meta-ads',                    icon: 'fa-brands fa-meta',             title: 'Meta Ads',      desc: 'Facebook and Instagram lead ads that target buyers and sellers in your exact market.' },
  { href: '/services/websites-funnels/landing-pages',  icon: 'fa-solid fa-house-laptop',      title: 'Landing Pages', desc: 'IDX-integrated property search pages that capture buyer leads and route them to your CRM.' },
];
      ...
      <main>
        ...
        <div style={{ background: '#fff', borderBottom: '1px solid var(--color-border)', padding: '12px 0' }}>
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <i className="fa-solid fa-chevron-right" style={{ fontSize: 9, color: 'var(--color-text-muted)' }} />
            <span style={{ fontFamily: I, fontSize: 13, color: 'var(--color-primary)', fontWeight: 500 }}>Real Estate</span>
          </div>
        </div>
        ...
        <section style={{ background: 'var(--color-bg-soft)', padding: '104px 0', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', textAlign: 'center', position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'var(--ism-blue-50)', border: '1px solid var(--ism-blue-100)', borderRadius: 100, padding: '6px 18px', marginBottom: 28 }}>
              ...
              <span style={{ fontFamily: J, fontSize: 12, fontWeight: 700, color: 'var(--color-primary)', letterSpacing: '.09em', textTransform: 'uppercase' }}>Real Estate</span>
            </div>
            <h1 style={{ fontFamily: J, fontWeight: 900, fontSize: 'clamp(28px,3.8vw,56px)', color: 'var(--color-navy)', lineHeight: 1.1, letterSpacing: '-0.5px', marginBottom: 22, maxWidth: 860, margin: '0 auto 22px' }}>
              Fill Your Pipeline with Qualified Buyers<br />&amp; Sellers Using Digital Marketing.
            </h1>
            <p style={{ fontFamily: I, fontSize: 'clamp(15px,1.2vw,18px)', color: 'var(--color-text-muted)', lineHeight: 1.78, maxWidth: 640, margin: '0 auto 40px' }}>
              We build the digital marketing systems that keep real estate professionals busy — local SEO that owns your market, ads that generate buyer and seller leads, and automation that follows up every inquiry until they are ready to move.
            </p>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, flexWrap: 'wrap' }}>
              <a href="/contact"
                ...
                Get Free Lead Gen Strategy <i className="fa-solid fa-arrow-right" style={{ fontSize: 11 }} />
              </a>
              <a href="/industries"
        ...
        <section style={{ padding: '56px 0', background: '#fff' }}>
          <div style={{ maxWidth: 1240, margin: '0 auto', padding: '0 28px' }}>
            <div className="re-stats" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 1, background: 'var(--color-border)', borderRadius: 16, overflow: 'hidden' }}>
              {STATS.map((s, i) => (
          ...
          <style>{`@media(max-width:640px){.re-stats{grid-template-columns:1fr!important;}}`}</style>
        </section>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div className="ism-container">
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px', marginBottom: 16 }}>The Full Digital Marketing Stack for Real Estate</h2>
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', lineHeight: 1.75, maxWidth: 580, margin: '0 auto' }}>Every channel that generates buyer and seller inquiries — purpose-built for agents, brokers, and real estate teams.</p>
            </div>
            <div className="re-what-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 24 }}>
              {WHAT_WE_DO.map((w, i) => (
          ...
          <style>{`@media(max-width:900px){.re-what-grid{grid-template-columns:repeat(2,1fr)!important;}}@media(max-width:580px){.re-what-grid{grid-template-columns:1fr!important;}}`}</style>
        </section>
        ...
        <section style={{ padding: '72px 0', background: '#fff' }}>
          <div className="ism-container">
            <div style={{ textAlign: 'center', marginBottom: 40 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(20px,2vw,32px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>The Channels Filling Your Pipeline</h2>
            </div>
        ...
        <section style={{ padding: '104px 0', background: 'var(--color-bg-soft)' }}>
          <div className="ism-container">
            <div style={{ textAlign: 'center', marginBottom: 60 }}>
              ...
              <h2 style={{ fontFamily: J, fontWeight: 800, fontSize: 'clamp(22px,2.4vw,38px)', color: 'var(--color-navy)', letterSpacing: '-0.4px' }}>How We Build Your Real Estate Lead Machine</h2>
            </div>
            <div className="re-process-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 24 }}>
              {PROCESS.map(p => (
          ...
          <style>{`@media(max-width:900px){.re-process-grid{grid-template-columns:repeat(2,1fr)!important;}}@media(max-width:520px){.re-process-grid{grid-template-columns:1fr!important;}}`}</style>
        </section>
        ...
        <section style={{ padding: '104px 0', background: '#fff' }}>
          <div className="ism-container">
            <div style={{ textAlign: 'center', marginBottom: 52 }}>
              ...
              <p style={{ fontFamily: I, fontSize: 16, color: 'var(--color-text-muted)', marginTop: 12 }}>The individual services powering your real estate growth strategy.</p>
            </div>
            <div className="re-related-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 24 }}>
              {RELATED.map(r => (
          ...
          <style>{`@media(max-width:860px){.re-related-grid{grid-template-columns:1fr!important;}}@media(max-width:1100px) and (min-width:861px){.re-related-grid{grid-template-columns:repeat(2,1fr)!important;}}`}</style>
        </section>
