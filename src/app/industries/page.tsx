...
const INDUSTRIES = [
  ...
  { icon: 'fa-solid fa-spa',                tag: 'Aesthetics',     title: 'Med Spas & Aesthetics',       desc: 'Social content and paid ads built to sell the result, not just the treatment menu.', href: '/contact', img: '1570172619644-dfd03ed5d881' },
  { icon: 'fa-solid fa-hammer',             tag: 'Renovation',     title: 'Home Renovation & Remodeling',desc: 'Before-and-after content and local ads that turn browsers into signed remodeling contracts.', href: '/contact', img: '1600607686527-6fb886090705' },
  { icon: 'fa-solid fa-house-chimney',      tag: 'Roofing',        title: 'Roofing Contractors',         desc: 'Storm-response ad campaigns and local SEO that keep the phone ringing all season long.', href: '/contact', img: '1503387762-592deb58ef4e' },
  { icon: 'fa-solid fa-faucet-drip',        tag: 'Plumbing',       title: 'Plumbing Services',           desc: 'Emergency-ready Google Ads and automated follow-up so no midnight call goes unanswered.', href: '/contact', img: '1558618666-fcd25c85cd64' },
  { icon: 'fa-solid fa-bolt',               tag: 'Electrical',     title: 'Electrical Contractors',      desc: 'Local SEO and lead routing built for the jobs that come in needing same-day service.', href: '/contact', img: '1621905251918-48416bd8575a' },
  { icon: 'fa-solid fa-seedling',           tag: 'Landscaping',    title: 'Landscaping & Lawn Care',     desc: 'Seasonal campaigns and route-based local SEO that keep your crews booked all year.', href: '/contact', img: '1558904541-efa843a96f01' },
  { icon: 'fa-solid fa-bug',                tag: 'Pest Control',   title: 'Pest Control',                desc: 'Recurring-service marketing built around renewals, not just one-time treatment calls.', href: '/contact', img: '1600585154340-be6161a56a0c' },
  { icon: 'fa-solid fa-dumbbell',           tag: 'Fitness',        title: 'Fitness Studios & Gyms',      desc: 'Membership funnels and local ads built to fill classes and keep churn low.', href: '/contact', img: '1534438327276-14e5300c3a48' },
  { icon: 'fa-solid fa-user-doctor',        tag: 'Wellness',       title: 'Chiropractic & Physical Therapy', desc: 'Local SEO and automated recall campaigns that keep patients coming back for their next visit.', href: '/contact', img: '1571019613454-1cb2f99b2d8b' },
  { icon: 'fa-solid fa-paw',                tag: 'Veterinary',     title: 'Veterinary Clinics',          desc: 'Local visibility and appointment reminders that keep your exam rooms full every week.', href: '/contact', img: '1583337130417-3346a1be7dee' },
  { icon: 'fa-solid fa-utensils',           tag: 'Hospitality',    title: 'Restaurants & Cafes',         desc: 'Social content and local SEO that turn nearby searches into filled tables.', href: '/contact', img: '1517248135467-4c7edcad34c4' },
  { icon: 'fa-solid fa-bed',                tag: 'Hospitality',    title: 'Hotels & Hospitality',        desc: 'Paid media and content built to win direct bookings away from the big travel platforms.', href: '/contact', img: '1566073771259-6a8506099945' },
  { icon: 'fa-solid fa-scissors',           tag: 'Beauty',         title: 'Salons & Spas',               desc: 'Social content and booking automation that keep your chairs filled week after week.', href: '/contact', img: '1560066984-138dadb4c035' },
  { icon: 'fa-solid fa-car',                tag: 'Automotive',     title: 'Auto Repair & Dealerships',   desc: 'Local SEO and service reminders that bring drivers back before the next big repair.', href: '/contact', img: '1486262715619-67b85e0b08d3' },
  { icon: 'fa-solid fa-truck',              tag: 'Moving',         title: 'Moving & Storage Companies',  desc: 'Seasonal ad campaigns and local SEO built around the exact weeks people are searching.', href: '/contact', img: '1600518464441-9154a4dea21b' },
  { icon: 'fa-solid fa-shield-halved',      tag: 'Insurance',      title: 'Insurance Agencies',          desc: 'Lead-gen funnels and nurture sequences built for long consideration cycles and renewals.', href: '/contact', img: '1450101499163-c8848c66ca85' },
  { icon: 'fa-solid fa-chart-line',         tag: 'Financial',      title: 'Financial Advisors',          desc: 'Trust-first content and lead-gen funnels built for a compliance-conscious industry.', href: '/contact', img: '1454165804606-c3d57bc86b40' },
  { icon: 'fa-solid fa-calculator',         tag: 'Accounting',     title: 'Accounting & Bookkeeping',    desc: 'Seasonal campaigns and referral-driven SEO built around your busiest filing months.', href: '/contact', img: '1554224154-22dec7ec8818' },
  { icon: 'fa-solid fa-store',              tag: 'Franchise',      title: 'Franchises & Multi-Location', desc: 'Multi-location SEO and centralized reporting that scale consistently across every site.', href: '/contact', img: '1553413077-190dd305871c' },
  { icon: 'fa-solid fa-graduation-cap',     tag: 'Education',      title: 'Education & Online Courses',  desc: 'Content and funnels built to turn curious visitors into enrolled students.', href: '/contact', img: '1524995997946-a1c2e315a42f' },
  { icon: 'fa-solid fa-hand-holding-heart', tag: 'Non-Profit',     title: 'Non-Profits & NGOs',          desc: 'Storytelling-led campaigns built to grow donors and volunteers, not just page views.', href: '/contact', img: '1593113646773-028c64a8f1b8' },
  { icon: 'fa-solid fa-champagne-glasses',  tag: 'Events',         title: 'Event Planning & Venues',     desc: 'Visual-first marketing and local SEO that keep your calendar booked further out.', href: '/contact', img: '1519167758481-83f550bb49b3' },
  { icon: 'fa-solid fa-broom',              tag: 'Cleaning',       title: 'Cleaning Services',           desc: 'Recurring-service funnels and local SEO built around trust and reliability.', href: '/contact', img: '1581578731548-c64695cc6952' },
  { icon: 'fa-solid fa-solar-panel',        tag: 'Solar',          title: 'Solar & Renewable Energy',    desc: 'Lead-gen campaigns built for a long sales cycle and a high-consideration purchase.', href: '/contact', img: '1509391366360-2e959784a276' },
  { icon: 'fa-solid fa-helmet-safety',      tag: 'Construction',   title: 'Construction & Contractors',  desc: 'Portfolio-led content and local SEO that win the bigger jobs, not just the small ones.', href: '/contact', img: '1590069261209-f8e9b8642343' },
  { icon: 'fa-solid fa-chalkboard-user',    tag: 'Coaching',       title: 'Coaches & Consultants',       desc: 'Personal-brand content and funnels built to turn followers into paying clients.', href: '/contact', img: '1552664730-d307ca884978' },
  { icon: 'fa-solid fa-bag-shopping',       tag: 'Retail',         title: 'Retail Stores',               desc: 'Local SEO and social content that bring foot traffic back into your store.', href: '/contact', img: '1441984904996-e0b6ba687e04' },
];
            ...
            <div className="ind-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 28 }}>
              {INDUSTRIES.map((ind, i) => (
                <a key={i} href={ind.href} className="ind-card" style={{ position: 'relative', display: 'block', height: 420, borderRadius: 24, overflow: 'hidden', textDecoration: 'none', boxShadow: '0 10px 30px rgba(0,35,83,.10)', transition: 'transform .25s, box-shadow .25s' }}
                  onMouseEnter={e => { const el = e.currentTarget as HTMLAnchorElement; el.style.transform = 'translateY(-6px)'; el.style.boxShadow = '0 22px 48px rgba(0,35,83,.20)'; }}
                  onMouseLeave={e => { const el = e.currentTarget as HTMLAnchorElement; el.style.transform = ''; el.style.boxShadow = '0 10px 30px rgba(0,35,83,.10)'; }}>
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={`https://images.unsplash.com/photo-${ind.img}?w=700&q=75`} alt={ind.title} style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
