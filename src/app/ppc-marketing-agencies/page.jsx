...
const TIMELINE_STEPS = [
  ...
  { num: 4, period: 'Regular Optimization & Testing',     desc: <>Every two weeks, we tune up your account: adding negative keywords, pausing bad ads, and sending more budget to winning ads.</> },
...
const DIFFERENTIATORS = [
  ...
  { dark: false, icon: 'fa-solid fa-chart-line',   title: 'Tracking That Shows Real Revenue',        desc: <>We set up tracking that connects your ad spend directly to actual leads and sales. You see the true cost to get a customer, not just useless click numbers.</> },
...
const FAQS = [
  { q: 'How quickly will I see results from PPC management services?',       a: <>You will see website traffic the exact day your ads go live. Good lead volume usually starts coming in within 2 to 4 weeks as ad platforms learn who your buyers are. Accounts usually hit peak performance between months 2 and 3.</> },
  ...
  { q: 'What is a good ROAS for Google Ads?',                                a: <>A good Return on Ad Spend (ROAS) is usually between 3x and 5x (300% to 500%) for online stores. For lead generation accounts, we focus on hitting a target Cost Per Lead (CPL) that lets you make a great profit on every sale.</> },
    ...
    <>
      ...
      <main>
          ...
          <div className="ism-container">
            ...
            <div className="ppc-strategy-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center', marginBottom:52 }}>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:26 }}>
                {[
                  { num:'01', title:'Your buyers are searching and active right now', text:<>Google processes 8.5 billion search queries every day. Partnering with a skilled Google Ads management agency puts your brand at the very top of Page 1 the moment your campaign launches, bypassing month-long wait times.</> },
                  { num:'02', title:'Paid search clicks carry higher buying intent', text:<>A user typing a high-intent transactional search term is already primed to buy. Paid search clicks convert at drastically higher rates than general blog traffic because commercial intent is established before they land.</> },
                  { num:'03', title:'Complete real-time control over targeting & spend', text:<>From granular geographic radius parameters to hyper-focused buyer demographics, paid media offers unmatched control. You control exactly who sees your offers, when they appear, and how the budget is allocated.</> },
                  { num:'04', title:'Proper campaign structure makes or breaks profitability', text:<>Most failed campaigns suffer from poor keyword match types, weak landing pages, and unoptimized ad copy. Expert oversight from leading PPC marketing agencies bridges the gap between losing money and achieving a 4x–5x ROAS.</> },
                  { num:'05', title:'Paid ad data sharpens your entire marketing engine', text:<>Real-time conversion data reveals exactly which hooks, keywords, and landing page angles resonate with buyers. That intelligence refines your SEO strategy, content marketing, and core sales offers simultaneously.</> },
                ].map(item => (
            ...
            <div style={{ textAlign:'center' }}>
              <p style={{ fontFamily:I, fontSize:15, color:'var(--color-text-muted)', lineHeight:1.75, margin:'0 auto 22px', maxWidth:560 }}>
                Isuremedia builds every paid media campaign around one primary number: your cost per acquired customer (CPA). Everything else, target keyword clusters, custom audience segments, visual ad creatives, and high-converting landing pages, is made to hit that specific lead target.
              </p>
              <Link href="/contact"
          ...
          <div className="ism-container">
            ...
            <div className="ppc-imgtext-grid" style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:56, alignItems:'center' }}>
              ...
              <div style={{ display:'flex', flexDirection:'column', gap:20 }}>
                <p style={{ fontFamily:I, fontSize:15, color:'var(--color-text-muted)', lineHeight:1.80, margin:0 }}>Businesses running paid advertising are paying far too much to reach unqualified traffic. We fix that by tightening demographic and keyword targeting, testing high-converting ad creative, and restructuring your entire acquisition funnel based on real conversion data.</p>
                <p style={{ fontFamily:I, fontSize:15, color:'var(--color-text-muted)', lineHeight:1.80, margin:0 }}>As a full-service paid advertising agency, Isuremedia manages multi-channel campaigns across Google Search, Google Shopping, Meta (Facebook & Instagram), LinkedIn, YouTube and programmatic networks. Whether you need an elite Google Ads management agency, a creative-driven Meta ads agency or a targeted B2B LinkedIn ads agency, we scale your growth under one team and one unified dashboard all aligned toward maximizing your Return on Ad Spend (ROAS).</p>
                <div style={{ marginTop:8 }}>
                  <Link href="/contact" style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'15px 32px', borderRadius:8, fontFamily:J, fontSize:14, fontWeight:700, color:'var(--color-navy)', background:'var(--ism-amber)', textDecoration:'none', letterSpacing:'.04em', textTransform:'uppercase', boxShadow:'0 6px 20px rgba(255,176,0,.35)', transition:'all .18s', whiteSpace:'nowrap' }}
                    onMouseEnter={e=>{ e.currentTarget.style.transform='translateY(-2px)'; }} onMouseLeave={e=>{ e.currentTarget.style.transform=''; }}
                  >Book My Free PPC Audit <i className="fa-solid fa-arrow-right" style={{ fontSize:12 }} /></Link>
                </div>
              </div>
            </div>
          </div>
        ...
        <Testimonials
          ...
          subheading={<>Hear directly from brands and agencies scaling faster with our paid ads & growth strategies.</>}
        />
            ...
            <div className="ppc-svc-grid" style={{ display:'grid', gridTemplateColumns:'repeat(3,1fr)', border:'1px solid #E8EAF0', borderRadius:16, overflow:'hidden' }}>
              {SERVICES.map((s,i)=>(
                <div key={i} className={`ppc-svc-cell ppc-svc-cell-${i}`} style={{ padding:'36px 32px', borderRight:(i===2||i===SERVICES.length-1)?'none':'1px solid #E8EAF0', borderBottom:i<3?'1px solid #E8EAF0':'none', background:'#fff', transition:'background .18s', cursor:'default' }}
                  ...
                  <Link href={s.href} style={{ display:'inline-flex', alignItems:'center', gap:6, fontFamily:J, fontSize:12, fontWeight:700, color:'var(--color-primary)', textDecoration:'none', letterSpacing:'.03em', transition:'gap .18s' }}
                    onMouseEnter={e=>(e.currentTarget.style.gap='10px')} onMouseLeave={e=>(e.currentTarget.style.gap='6px')}
                  >Learn more <i className="fa-solid fa-arrow-right" style={{ fontSize:10 }} /></Link>
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{ background:'var(--color-primary)', borderRadius:24, padding:'60px 64px', display:'grid', gridTemplateColumns:'1fr 420px', gap:48, alignItems:'center', position:'relative', overflow:'hidden' }} className="ppc-rfr-grid">
            ...
            <div>
              ...
              <div style={{ display:'flex', alignItems:'center', gap:16, flexWrap:'wrap' }}>
                <Link href="/contact" style={{ display:'inline-flex', alignItems:'center', gap:8, padding:'15px 32px', borderRadius:8, fontFamily:J, fontSize:13, fontWeight:700, color:'var(--color-navy)', background:'var(--ism-amber)', textDecoration:'none', letterSpacing:'.05em', textTransform:'uppercase', boxShadow:'0 6px 20px rgba(255,176,0,.35)', transition:'all .18s', whiteSpace:'nowrap' }}
                  onMouseEnter={e=>{ e.currentTarget.style.transform='translateY(-2px)'; }} onMouseLeave={e=>{ e.currentTarget.style.transform=''; }}
                >Get My Free PPC Audit</Link>
