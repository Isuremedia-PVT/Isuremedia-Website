...
export default function FernOakCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: <>Fern & Oak Interiors designs and sells premium home decor pieces, but their product photography and ad creative had not kept pace with the quality of the products themselves, and <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>it was starting to show in performance</span>.</>,
      meta: {
