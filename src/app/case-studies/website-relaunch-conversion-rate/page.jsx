...
export default function MiAmorCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: <>Mi Amor sells direct-to-consumer online, but their five-year-old website was slow, unclear about what they actually offered, and <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>losing visitors before checkout ever loaded</span>.</>,
      meta: {
