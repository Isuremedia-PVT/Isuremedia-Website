...
export default function WhiteLabelCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: <>Northline Digital is a UK-based marketing agency that had <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>hit a delivery ceiling</span> — every client won meant either turning away new business or stretching an already-full team even thinner.</>,
      meta: {
