...
export default function MeridianCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: <>Meridian Wealth Partners is a boutique financial advisory firm. Their website read well and looked professional, but visitors had no clear next step and <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>almost none of them ever booked a call</span>.</>,
      meta: {
