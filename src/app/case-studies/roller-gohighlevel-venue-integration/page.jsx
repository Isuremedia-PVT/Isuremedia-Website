...
export default function AirtopiaCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: <>Airtopia operates indoor entertainment venues across the US, including trampoline parks, family play centres, and similar destinations. They run ROLLER for venue operations and GoHighLevel for customer marketing. <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>The two had never been connected</span>.</>,
      meta: {
