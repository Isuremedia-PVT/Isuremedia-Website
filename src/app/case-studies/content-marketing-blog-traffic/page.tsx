...
export default function BloomBrightCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: 'Bloom & Bright is a lifestyle and wellness brand that never stopped publishing, but their blog and social content had drifted into the same generic voice as every competitor in the category.',
      meta: {
