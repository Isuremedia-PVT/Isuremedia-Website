...
export default function CoastalSupplyCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: <>Coastal Supply Co. sells outdoor and watersport gear direct to consumers. Product quality and reviews were strong, but product and category pages <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>rarely ranked past page two</span> for the terms that actually drove purchases.</>,
      meta: {
