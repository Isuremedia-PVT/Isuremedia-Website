...
export default function BrightPathCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: <>BrightPath Dental runs a busy general and cosmetic practice. Their Google Ads campaigns were live and spending steadily, but broad targeting and generic ad copy meant the front desk spent most of its day on <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>calls that were never going to book</span>.</>,
      meta: {
