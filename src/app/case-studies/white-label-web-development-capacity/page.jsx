...
export default function SummitGrowthCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: <>Summit Growth Partners is a US marketing agency whose sales team had started winning larger, more complex web design retainers — well beyond what their small in-house development team <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>could realistically deliver on time</span>.</>,
      meta: {
