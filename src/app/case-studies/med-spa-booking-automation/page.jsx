...
export default function BloomAestheticsCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: <>Bloom Aesthetics is a med spa offering injectables, facials, and skin treatments. Appointments were booked by hand with no reminder system beyond staff memory, and rebooking after treatment <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>depended entirely on someone remembering to ask</span>.</>,
      meta: {
