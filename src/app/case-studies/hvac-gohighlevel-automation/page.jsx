...
export default function HvacCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: <>Apex runs HVAC service and installation crews across three counties, generating leads through Google Ads and their Google Local Services listing. Follow-up was manual and inconsistent — <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>often hours late</span>, long enough for the customer to already book with a competitor.</>,
      meta: {
