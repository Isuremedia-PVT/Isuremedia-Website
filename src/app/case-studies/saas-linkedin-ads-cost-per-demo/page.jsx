...
export default function SaaSLinkedInCaseStudyPage() {
  return (
    <CaseStudyDetail data={{
      ...
      intro: <>TruckAC+ sells aftermarket climate control units for commercial trucking fleets, running paid social, PPC, and programmatic campaigns independently with <span style={{ background: 'rgba(255,176,0,.35)', borderRadius: 4, padding: '1px 6px', fontWeight: 700 }}>no shared measurement or retargeting strategy</span> between them.</>,
      meta: {
