...
const RELATED = [
  { icon: 'fa-brands fa-meta', title: 'Meta Ads', desc: 'Facebook and Instagram advertising built to reach, engage, and convert the right audiences.', href: '/meta-ads-management' },
