...
interface HirePageTemplateProps {
  title: string;
  subtitle: string;
  trustChips: string[];
  whyCards: Array<{ icon: string; title: string; desc: string }>;
  servicesTabs: Array<{ label: string; icon: string }>;
  servicesData: Array<{ num: string; title: string; img: string; desc: string; bullets: string[] }>;
  techCategories: Array<{ label: string; tools: string[] }>;
  whyISMCards: Array<{ icon: string; title: string; desc: string }>;
  engagementModels: Array<{ title: string; tag: string; desc: string; bullets: string[] }>;
  ...
  endingCTAImage: string;
  breadcrumb: string;
  pageName: string;
}

export default function HirePageTemplate(props: HirePageTemplateProps) {
