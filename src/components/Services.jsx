...
const tabs = [
  {
    ...
    subServices: [
      ...
      { name: 'ClickFunnels', href: '/clickfunnels-development' },
      { name: 'Business Websites', href: '/business-website-design-services' },
      { name: 'Sales Funnels', href: '/sales-funnel-design' },
      { name: 'Kajabi', href: '/kajabi-website-development' },
      { name: 'WordPress Development', href: '/wordpress-development-services' },
      { name: 'Shopify Development', href: '/shopify-development-services' },
      { name: 'GoHighLevel Development', href: '/gohighlevel-development-services' },
      { name: 'PHP / Laravel Development', href: '/php-laravel-development' },
      { name: 'Node.js Development', href: '/nodejs-development-services' },
      { name: 'Python Development', href: '/python-development-services' },
      { name: 'AI Development', href: '/ai-development-services' },
      { name: 'Wix Development', href: '/wix-website-development' },
    ],
  },
  {
  ...
  },
  {
    ...
    subServices: [
      ...
      { name: 'TikTok Ads', href: '/tiktok-ads-management' },
      { name: 'YouTube Ads', href: '/youtube-ads-management' },
    ],
  },
  {
    ...
    subServices: [
      ...
      { name: 'Brand Identity & Visual Design', href: '/brand-identity-design-services' },
      { name: 'Video Marketing & Editing', href: '/video-editing-services' },
    ],
  },
  {
    ...
    subServices: [
      ...
      { name: 'White-Label GoHighLevel Support', href: '/gohighlevel-white-label-support-services' },
  ...
  },
  {
    ...
    subServices: [
      ...
      { name: 'Make Automation', href: '/make-automation-services' },
      ...
      { name: 'Zoho', href: '/zoho-automation-setup' },
    ],
  },
];
