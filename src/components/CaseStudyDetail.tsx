...
export interface CaseStudyData {
  ...
  hook: string;
  intro: string;
  meta: { industry: string; location: string; duration: string; services: string };
  heroImage: string;
  resultHeadline: { text: string; highlight?: boolean }[];
  stats: { val: string; label: string; sub: string }[];
  quote: string;
  quoteBy: string;
  quoteRole: string;
  ...
  overviewTags: { label: string; tone: 'blue' | 'amber' }[];
  ...
  impactIntro: string;
  impactCards: { label: string; title: string; body: string }[];
  nextHeading: string;
  nextIntro: string;
  nextCards: { title: string; body: string }[];
  ctaEyebrow: string;
  ctaHeading: { text: string; highlight?: boolean }[];
  ctaBody: { text: string; highlight?: boolean }[];
...
export default function CaseStudyDetail({ data: d }: { data: CaseStudyData }) {
  return (
    <>
      <Navbar />
