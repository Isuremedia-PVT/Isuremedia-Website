    ...
    <section id="industries" className="ind-section" style={{ padding: '64px 0 64px', background: '#fff', position: 'relative' }}>
      ...
      <div style={{ position: 'relative' }}>
        ...
        <button onClick={prev} aria-label="Previous"
          ...
          onMouseLeave={e => { e.currentTarget.style.background = '#fff'; e.currentTarget.style.borderColor = '#e2e8f0'; (e.currentTarget.querySelector('i')).style.color = 'var(--color-primary)'; }}
        >
