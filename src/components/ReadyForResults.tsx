          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap' }}>
              <a
                ...
                onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.background = 'var(--color-accent-hover)'; (e.currentTarget as HTMLAnchorElement).style.transform = 'translateY(-2px)'; }}
                onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.background = 'var(--ism-amber)'; (e.currentTarget as HTMLAnchorElement).style.transform = ''; }}
              >
              ...
              <a
                ...
                onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.background = 'var(--color-primary-hover)'; (e.currentTarget as HTMLAnchorElement).style.transform = 'translateY(-2px)'; }}
