...
const serviceCategories = [
  {
    ...
    items: [
      { label: 'Business Websites',                     href: '/services/websites-funnels'                      },
      ...
      { label: 'Sales Funnels',                          href: '/services/websites-funnels'                      },
      { label: 'ClickFunnels',                           href: '/services/websites-funnels/clickfunnels'         },
      { label: 'Kajabi',                                 href: '/services/websites-funnels'                      },
      { label: 'Conversion Rate Optimisation (CRO)',     href: '/services/websites-funnels/cro'                  },
      { label: 'Website Redesign',                       href: '/services/websites-funnels'                      },
      { label: 'Website Maintenance & Support',          href: '/services/websites-funnels'                      },
      { label: 'AI-Powered Website Personalisation',     href: '/services/websites-funnels'                      },
    ],
  },
  {
    ...
    items: [
      ...
      { label: 'E-Commerce SEO',                    href: '/services/seo'               },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'YouTube Ads',                        href: '/services/ppc-paid-marketing'          },
      { label: 'Paid Social Media Advertising',      href: '/services/ppc-paid-marketing'          },
      { label: 'Programmatic Advertising',           href: '/services/ppc-paid-marketing'          },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Content Marketing',                   href: '/services/content-creative'                     },
      ...
      { label: 'Video Marketing & Editing',            href: '/services/content-creative'                     },
      { label: 'Email Marketing',                      href: '/services/content-creative/email-marketing'     },
      { label: 'Brand Identity & Visual Design',       href: '/services/content-creative'                     },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Dedicated Agency Pods',                 href: '/services/white-label'                         },
      { label: 'White-Label Content Marketing',         href: '/services/white-label/white-label-content'    },
      { label: 'White-Label Social Media Marketing',    href: '/services/white-label'                         },
      { label: 'White-Label Link Building',             href: '/services/white-label'                         },
      { label: 'White-Label Graphic Design',            href: '/services/white-label'                         },
      { label: 'White-Label Reporting & Dashboards',    href: '/services/white-label'                         },
    ],
  },
  {
    ...
    items: [
      ...
      { label: 'Lead Nurture Workflows',                     href: '/services/marketing-automation'       },
      ...
      { label: 'Appointment Booking Systems',                href: '/services/marketing-automation'       },
      { label: 'Email Marketing Automation',                 href: '/services/marketing-automation'       },
      { label: 'SMS & WhatsApp Automation',                  href: '/services/marketing-automation'       },
      { label: 'Sales Pipeline Automation',                  href: '/services/marketing-automation'       },
      { label: 'API Integration',                            href: '/services/marketing-automation'       },
      { label: 'Reporting & Dashboard Automation',           href: '/services/marketing-automation'       },
    ],
  },
];
